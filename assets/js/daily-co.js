  ...
  return (function () {
    var e = {
              ...
              var r,
                ...
                a = [
                  ...
                  },
                  {
                    ...
                    describe: function (e) {
                      var t =
                          i.default.getFirstMatch(/(can-l01)/i, e) && "Nova",
        ...
        948: function (e, t, n) {
          ...
          n.r(t),
            n.d(t, {
              DAILY_ACCESS_LEVEL_FULL: function () {
                return Yr;
              },
          ...
          function w(e, t) {
            ...
            if (e && t && (n = e.constructor) === t.constructor) {
              ...
              if (n === Set) {
                ...
                for (r of e) {
                  if ((i = r) && "object" == typeof i && !(i = S(t, i)))
                    return !1;
                  if (!t.has(i)) return !1;
                }
                return !0;
              ...
              if (n === Map) {
                if (e.size !== t.size) return !1;
                for (r of e) {
                  if ((i = r[0]) && "object" == typeof i && !(i = S(t, i)))
                    return !1;
                  if (!w(r[1], t.get(i))) return !1;
                }
                return !0;
              }
              if (n === ArrayBuffer)
              ...
              if (!n || "object" == typeof e) {
                for (n in ((r = 0), e)) {
                  if (b.call(e, n) && ++r && !b.call(t, n)) return !1;
          ...
          function C(e) {
            return null != e && e.callObjectBundleUrlOverride
          ...
          function B(e, t, n) {
            if (n[t.name])
              ...
              P && F.log(`Integration installed: ${t.name}`);
            }
          }
          ...
          function se(e, t, n) {
            ...
            const r = e[t],
              i = n(r);
            "function" == typeof i && ue(i, r);
            try {
              e[t] = i;
            } catch (n) {
              I && F.log(`Failed to replace method "${t}" in object`, e);
            }
          }
          function ce(e, t, n) {
            try {
          ...
          function Ee(e) {
            try {
              ...
              return (
                P && F.error(`Cannot extract url for event ${ye(e)}`), null
              );
            }
          }
          function Te() {
          ...
          function Me(e) {
            ...
            return (t.version = t.version || L), (t[L] = t[L] || {});
          }
          function Ae() {
            return Date.now() / 1e3;
          }
          ...
          (() => {
            const { performance: e } = D;
            if (!e || !e.now) return void (Oe = "none");
            const t = 36e5,
              n = e.now(),
              r = Date.now(),
            ...
            o || s < t
              ? i <= s
                ? ((Oe = "timeOrigin"), e.timeOrigin)
                : (Oe = "navigationStart")
              : (Oe = "dateNow");
          })();
          const Ne = "_sentrySpan";
          function je(e, t) {
            t ? ce(e, Ne, t) : delete e[Ne];
          }
          function Re(e) {
            return e[Ne];
          }
          class xe {
            constructor() {
              (this._notifyingListeners = !1),
                ...
                (this._propagationContext = { traceId: Ie(), spanId: Le() });
            }
            clone() {
              const e = new xe();
              return (
            ...
            clear() {
              return (
                ...
                je(this, void 0),
                (this._attachments = []),
                this.setPropagationContext({ traceId: Ie() }),
                this._notifyScopeListeners(),
                this
              );
            }
            ...
            setSDKProcessingMetadata(e) {
              return (
                (this._sdkProcessingMetadata = De(
                  this._sdkProcessingMetadata,
                  e,
                  2
                )),
            ...
            setPropagationContext(e) {
              return (this._propagationContext = { spanId: Le(), ...e }), this;
            }
            getPropagationContext() {
              return this._propagationContext;
            }
            captureException(e, t) {
              const n = t && t.event_id ? t.event_id : ge();
              if (!this._client)
                return (
                  F.warn(
          ...
          class Ve {
            ...
            _pushScope() {
              ...
              return (
                this._stack.push({ client: this.getClient(), scope: e }), e
              );
            }
            _popScope() {
          ...
          function Ue() {
            ...
            return (e.stack =
              e.stack ||
              new Ve(
                N("defaultCurrentScope", () => new Fe()),
                N("defaultIsolationScope", () => new Fe())
              ));
          }
          function Be(e) {
            return Ue().withScope(e);
          }
          function Je(e, t) {
            const n = Ue();
          ...
          function Ye(e) {
            return Ue().withScope(() => e(Ue().getIsolationScope()));
          }
          function $e(e) {
            const t = Me(e);
            return t.acs
              ...
              : {
                  ...
                  getIsolationScope: () => Ue().getIsolationScope(),
                };
          }
          function qe() {
          ...
          function ze(e) {
            ...
            return he({ trace_id: n, span_id: r, parent_span_id: i });
          }
          let He;
          const Ke = new WeakMap(),
            ...
            Xe = "?",
            Ze = /\(error: (.*)\)/,
            et = /captureMessage|captureException/;
          function tt(e) {
            return e[e.length - 1] || {};
          }
          const nt = "<anonymous>";
          function rt(e) {
            try {
              return (e && "function" == typeof e && e.name) || nt;
            } catch (e) {
              return nt;
            }
          }
          ...
          function ft(e, t) {
            if (!lt[e]) {
              ...
              try {
                ...
                I && F.error(`Error while instrumenting ${e}`, t);
              }
            }
          }
          function pt(e, t) {
          ...
          function yt() {
            ...
            const e = pt.bind(null, "dom"),
              t = _t(e, !0);
            ht.document.addEventListener("click", t, !1),
              ht.document.addEventListener("keypress", t, !1),
              ["EventTarget", "Node"].forEach((t) => {
                ...
                r &&
                  ...
                  (se(r, "addEventListener", function (t) {
                  ...
                  se(r, "removeEventListener", function (e) {
          ...
          function _t(e, t = !1) {
            return (n) => {
              ...
              if (
                ...
                return;
              ce(n, "_sentryCaptured", !0),
                r && !r._sentryId && ce(r, "_sentryId", ge());
              const i = "keypress" === n.type ? "input" : n.type;
              (function (e) {
                if (e.type !== gt) return !1;
                try {
                  if (!e.target || e.target._sentryId !== mt) return !1;
                } catch (e) {}
                return !0;
              })(n) ||
          ...
          function St() {
            ...
            (e.open = new Proxy(e.open, {
              apply(e, t, n) {
                ...
                (t[bt] = { method: o, url: a, request_headers: {} }),
                  "POST" === o &&
                    a.match(/sentry_key/) &&
                ...
                apply(e, t, n) {
                  ...
                  return r
                    ? (void 0 !== n[0] && (r.body = n[0]),
                      pt("xhr", { startTimestamp: 1e3 * Ce(), xhr: t }),
                      e.apply(t, n))
                    : e.apply(t, n);
                },
              }));
            ...
            function t(e) {
              return function (...t) {
                ...
                if (n) {
                  const e = kt,
                    t = String(n);
                  (kt = t), pt("history", { from: e, to: t });
                }
                return e.apply(this, t);
              };
            }
            (ht.onpopstate = function (...t) {
              const n = ht.location.href,
                r = kt;
              if (((kt = n), pt("history", { from: r, to: n }), e))
                try {
                  return e.apply(this, t);
                } catch (e) {}
            }),
              se(ht.history, "pushState", t),
              se(ht.history, "replaceState", t);
          }
          function Mt() {
            "console" in D &&
              j.forEach(function (e) {
                e in D.console &&
                  se(D.console, e, function (t) {
                    return (
                      (R[e] = t),
                      function (...t) {
                        pt("console", { args: t, level: e });
                        const n = R[e];
                    ...
                    t.apply(D, n).then(
                      ...
                      (e) => {
                        throw (
                          ...
                          Y(e) &&
                            void 0 === e.stack &&
                            ((e.stack = r.stack), ce(e, "framesToPop", 1)),
                          e)
                        );
                      }
                    )
          ...
          function Dt(e, t) {
            const n = Ge(),
              r = We();
            if (!n) return;
            const { beforeBreadcrumb: i = null, maxBreadcrumbs: o = Lt } =
              n.getOptions();
            if (o <= 0) return;
            const a = { timestamp: Ae(), ...e },
              s = i ? x(() => i(a, t)) : a;
            null !== s &&
          ...
          class Bt {
            ...
            __init() {
              this._resolve = (e) => {
                this._setResult(Ft.RESOLVED, e);
              };
            }
            __init2() {
              this._reject = (e) => {
                this._setResult(Ft.REJECTED, e);
              };
            }
            __init3() {
              this._setResult = (e, t) => {
            ...
            __init4() {
              this._executeHandlers = () => {
                ...
                (this._handlers = []),
                  e.forEach((e) => {
                    e[0] ||
                      (this._state === Ft.RESOLVED && e[1](this._value),
                      this._state === Ft.REJECTED && e[2](this._value),
                      (e[0] = !0));
                  });
              };
            }
            ...
            return new Bt((i, o) => {
              ...
              if (null === t || "function" != typeof a) i(t);
                ...
                P &&
                  a.id &&
                  null === s &&
                  F.log(`Event processor "${a.id}" dropped event`),
                  X(s)
                    ? s.then((t) => Jt(e, t, n, r + 1).then(i)).then(null, o)
                    : Jt(e, s, n, r + 1)
                        .then(i)
                        .then(null, o);
              }
            ...
            const s = (function (e, t) {
              try {
                ...
                if ("number" == typeof t && !Number.isFinite(t))
                  return `[${t}]`;
                if ("function" == typeof t) return `[Function: ${rt(t)}]`;
          ...
          function Qt(e) {
            ...
            if (!t) return;
            const n = {};
            for (const [, [e, r]] of t) (n[e] || (n[e] = [])).push(he(r));
            return n;
          }
          let Xt = !1;
          function Zt(e) {
            ...
            return he({
              parent_span_id: r ? t : nn(e).parent_span_id,
              span_id: r ? Le() : t,
              trace_id: n,
            });
          }
            ...
            try {
              ...
              if (
                ...
                return he({
                  ...
                  description: o,
                  parent_span_id: s,
                  start_timestamp: en(i),
                  timestamp: en(a) || void 0,
                  status: rn(c),
                  op: r["sentry.op"],
                  origin: r["sentry.origin"],
                  _metrics_summary: Qt(e),
                });
              }
              ...
              a =
                ...
                (function (e) {
                  ...
                  const n = Object.entries(t).reduce(
                    (e, [t, n]) => (t.match(Ht) && (e[t.slice(7)] = n), e),
                    {}
                  );
                  return Object.keys(n).length > 0 ? n : void 0;
                })(o);
            if (a) return a;
            const s = an(e.spanContext().traceId, t),
              c = nn(n),
              u = c.data || {},
              l = u["sentry.sample_rate"];
            null != l && (s.sample_rate = `${l}`);
          ...
          function cn(e, t) {
            ...
            un(e, "extra", n),
              ...
              un(e, "user", i),
              un(e, "contexts", o),
              (e.sdkProcessingMetadata = De(e.sdkProcessingMetadata, s, 2)),
              a && (e.level = a),
          ...
          function ln(e, t, n, r, i, o) {
            ...
            !(function (e, t) {
              ...
              (e.environment = e.environment || n || xt),
                !e.release && r && (e.release = r),
                !e.dist && i && (e.dist = i),
                e.message && (e.message = ie(e.message, o));
              const a =
                e.exception && e.exception.values && e.exception.values[0];
              a && a.value && (a.value = ie(a.value, o));
              const s = e.request;
              s && s.url && (s.url = ie(s.url, o));
            })(c, e),
              (function (e, t) {
                t.length > 0 &&
                  ((e.sdk = e.sdk || {}),
            ...
            const l = (function (e, t) {
              if (!t) return e;
              const n = e ? e.clone() : new Fe();
              return n.update(t), n;
            })(r, n.captureContext);
            n.mechanism && be(c, n.mechanism);
            const d = i ? i.getEventProcessors() : [],
              f = N("globalScope", () => new Fe()).getScopeData();
            o && cn(f, o.getScopeData()), l && cn(f, l.getScopeData());
            ...
            return (
              ...
              (function (e, t) {
                ...
                !(function (e, t) {
                  ...
                  r &&
                    (function (e, t) {
                      (e.contexts = { trace: Zt(t), ...e.contexts }),
                        (e.sdkProcessingMetadata = {
                          dynamicSamplingContext: sn(t),
                          ...e.sdkProcessingMetadata,
                        });
                      const n = nn(on(t)).description;
                      n &&
                        !e.transaction &&
                        "transaction" === e.type &&
                        (e.transaction = n);
              ...
              Jt([...d, ...f.eventProcessors], c, n).then(
                (e) => (
                  e &&
                    (function (e) {
                      const t = {};
                    ...
                    ? (function (e, t, n) {
                        ...
                        return (
                          ...
                          e.contexts &&
                            e.contexts.flags &&
                            r.contexts &&
                            (r.contexts.flags = Wt(e.contexts.flags, 3, n)),
                          r
                        );
                      })(e, a, s)
                    : e
          ...
          function pn(e) {
            const t = Ge(),
              n = We(),
              r = qe(),
              { release: i, environment: o = xt } = (t && t.getOptions()) || {},
              { userAgent: a } = D.navigator || {},
              s = (function (e) {
                const t = Ce(),
                  n = {
                    sid: ge(),
              ...
              c = n.getSession();
            return (
              c && "ok" === c.status && Pe(c, { status: "exited" }),
              hn(),
              n.setSession(s),
              r.setSession(s),
              s
          ...
          function hn() {
            ...
            n &&
              (function (e) {
                let t = {};
                "ok" === e.status && (t = { status: "exited" }), Pe(e, t);
              })(n),
              vn(),
              e.setSession(),
              t.setSession();
          ...
          function bn(e, t = {}) {
                ...
                throw (
                  ...
                  (function (...e) {
                    ...
                    r.addEventProcessor(
                      (e) => (
                        t.mechanism &&
                          (_e(e, void 0, void 0), be(e, t.mechanism)),
                      ...
                      qe().captureException(
                        ...
                        (function (e) {
                          if (e)
                            return (function (e) {
                              return e instanceof Fe || "function" == typeof e;
                            })(e) ||
                              (function (e) {
            ...
            ue(n, e), ce(e, "__sentry_wrapped__", n);
            try {
          ...
          const Sn = (e = {}) => {
                ...
                setup(e) {
                  ...
                  t.console &&
                        ...
                        return function (t) {
                          ...
                          if ("assert" === t.level) {
                            ...
                            (n.message = `Assertion failed: ${
                              oe(t.args.slice(1), " ") || "console.assert"
                            }`),
                              (n.data.arguments = t.args.slice(1));
                          }
                          Dt(n, { input: t.args, level: t.level });
                        };
                      })(e)
                    ),
                    t.dom &&
                          ...
                          try {
                            const e = n.event,
                              t = (function (e) {
                                ...
                                ? e.target
                                : e;
                            (r = ne(t, { keyAttrs: o, maxStringLength: a })),
                              (i = (function (e) {
                        ...
                        (function (e) {
                          return function (t) {
                            ...
                            const {
                              ...
                              u = { method: o, url: a, status_code: s },
                              l = {
                                xhr: t.xhr,
                                input: c,
                                startTimestamp: n,
                    ...
                    t.fetch &&
                      (function (e) {
                        const t = "fetch";
                        dt(t, e), ft(t, () => Ot(void 0, undefined));
                      })(
                        (function (e) {
                          return function (t) {
                            if (Ge() !== e) return;
            ...
            kn = (e = {}) => {
              ...
              return {
                ...
                setupOnce() {
                  t.setTimeout && se(mn, "setTimeout", En),
                    t.setInterval && se(mn, "setInterval", En),
                    t.requestAnimationFrame &&
                      se(mn, "requestAnimationFrame", Tn),
                    t.XMLHttpRequest &&
                      "XMLHttpRequest" in mn &&
                      se(XMLHttpRequest.prototype, "send", Mn);
                  const e = t.eventTarget;
                  e && (Array.isArray(e) ? e : wn).forEach(An);
                },
              };
            };
          function En(e) {
          ...
          function Tn(e) {
            return function (t) {
              return e.apply(this, [
                bn(t, {
                  mechanism: {
                    data: { function: "requestAnimationFrame", handler: rt(e) },
                    handled: !1,
                    type: "instrument",
                  },
                }),
                ...
                [
                  ...
                  e in n &&
                    ...
                    se(n, e, function (t) {
                      const n = {
                          mechanism: {
                            data: { function: e, handler: rt(t) },
                            handled: !1,
                            type: "instrument",
                          },
                        },
                        r = le(t);
                      return r && (n.mechanism.data.handler = rt(r)), bn(t, n);
                    });
                }),
                e.apply(this, t)
              );
          ...
          function An(e) {
            ...
            n &&
              ...
              (se(n, "addEventListener", function (t) {
                return function (n, r, i) {
                  try {
                    "function" == typeof r.handleEvent &&
                      (r.handleEvent = bn(r.handleEvent, {
                        mechanism: {
                          data: {
          ...
          let Pn = null;
          function In() {
            (Pn = D.onunhandledrejection),
              (D.onunhandledrejection = function (e) {
                return (
                  pt("unhandledrejection", e), !Pn || Pn.apply(this, arguments)
                );
              }),
          ...
          function Dn(e, t) {
            return { exception: { values: [Ln(e, t)] } };
          }
          function Nn(e, t) {
            const n = t.stacktrace || t.stack || "",
              r = (function (e) {
                return e && jn.test(e.message) ? 1 : 0;
              })(t),
              i = (function (e) {
          ...
          function Fn(e) {
            ...
            return t
              ? t.error && "string" == typeof t.error.message
                ? t.error.message
                : Rn(e) && Array.isArray(e.message) && 2 == e.message.length
                ? e.message[1]
                : t
              : "No error message";
          }
          function Vn(e, t, n, r, i) {
            let o;
            if (q(t) && t.error) return Dn(e, t.error);
            if (W(t) || $(t, "DOMException")) {
              const i = t;
              if ("stack" in t) o = Dn(e, t);
              else {
                const t = i.name || (W(i) ? "DOMError" : "DOMException"),
            ...
            return Y(t)
              ...
              ? ((o = (function (e, t, n, r) {
                  const i = Ge(),
                    ...
                    s = { __serialized__: Gt(t, o) };
                  if (a) return { exception: { values: [Ln(e, a)] }, extra: s };
                  const c = {
                    exception: {
                      values: [
                        {
                          type: Q(t)
                            ...
                            ? "UnhandledRejection"
                            : "Error",
                          value: Bn(t, { isUnhandledRejection: r }),
                        },
                      ],
                    },
                    extra: s,
          ...
          function Bn(e, { isUnhandledRejection: t }) {
            const n = (function (e, t = 40) {
                const n = Object.keys(de(e));
                n.sort();
                const r = n[0];
                if (!r) return "[object has no keys]";
                if (r.length >= t) return ie(r, t);
                ...
                t.onerror &&
                  ((function (e) {
                    !(function () {
                      const t = "error";
                      dt(t, (t) => {
                        const { stackParser: n, attachStacktrace: r } = $n();
                        if (Ge() !== e || _n()) return;
                        const {
                            msg: i,
                            url: o,
                  ...
                  t.onunhandledrejection &&
                    ...
                    Yn("onunhandledrejection"));
              },
            };
          };
          function Yn(e) {
            Rt && F.log(`Global Handler attached: ${e}`);
          }
          function $n() {
            const e = Ge();
            return (
          ...
          function qn(e, t, n = 250, r, i, o, a) {
            if (
              !(
                o.exception &&
                o.exception.values &&
                a &&
                Z(a.originalException, Error)
              )
            )
              return;
            const s =
            ...
            s &&
              (o.exception.values =
                ...
                (u = n),
                c.map((e) => (e.value && (e.value = ie(e.value, u)), e))));
          }
          function Wn(e, t, n, r, i, o, a, s) {
            ...
            if (Z(r[i], Error)) {
              ...
              const o = e(t, r[i]),
                u = c.length;
              zn(o, i, u, s), (c = Wn(e, t, n, r[i], i, [o, ...c], o, u));
            }
            return (
          ...
          const Hn = (e = {}) => {
            ...
            return {
              ...
              preprocessEvent(e, r, i) {
                ...
                qn(Ln, o.stackParser, o.maxValueLength, n, t, e, r);
              },
            };
          };
          function Kn(e) {
              ...
              ot(),
              {
                ...
                preprocessEvent(e) {
                  ...
                  const t =
                      ...
                      (mn.location && mn.location.href),
                    { referrer: n } = mn.document || {},
                    { userAgent: r } = mn.navigator || {},
                    i = {
          ...
          function ir(e) {
            ...
            function i(e) {
              "string" == typeof r
                ? (r = "string" == typeof e ? r + e : [rr(r), e])
                : r.push("string" == typeof e ? rr(e) : e);
            }
            for (const e of n) {
              const [t, n] = e;
              if (
          ...
          function or(e) {
            const t = "string" == typeof e.data ? rr(e.data) : e.data;
            return [
              he({
                type: "attachment",
                length: t.length,
          ...
          class dr {
            constructor(e) {
              if (
                ...
                e.dsn
                        ...
                        (function (e) {
                          ...
                          return !(
                            ["protocol", "publicKey", "host", "projectId"].find(
                              (t) =>
                                !e[t] &&
                                (F.error(`Invalid Sentry Dsn: ${t} missing`),
                                !0)
                            ) ||
                            (n.match(/^\d+$/)
                              ? (function (e) {
                  ...
                  : P &&
                    F.warn("No DSN provided, client will not send events."),
                this._dsn)
              ) {
                const i =
                  ((t = this._dsn),
            ...
            captureException(e, t, n) {
              const r = ge();
              if (Se(e)) return P && F.log(lr), r;
              const i = { event_id: r, ...t };
              return (
                this._process(
            ...
            captureEvent(e, t, n) {
              ...
              return (
                this._process(this._captureEvent(e, i, o || n)), i.event_id
              );
            }
            captureSession(e) {
            ...
            addIntegration(e) {
              ...
              B(this, e, this._integrations), t || U(this, [e]);
            }
            sendEvent(e, t = {}) {
              ...
              let n = (function (e, t, n, r) {
                ...
                return (
                  delete e.sdkProcessingMetadata, er(a, [[{ type: o }, e]])
                );
              })(e, this._dsn, this._options._metadata, this._options.tunnel);
              for (const e of t.attachments || []) n = tr(n, or(e));
                ...
                this._isEnabled() && this._transport
                  ? this._transport
                      ...
                      .then(
                        null,
                        (e) => (
                          P && F.error("Error while sending envelope:", e), e
                        )
                      )
                  : (P && F.error("Transport disabled"), Vt({}))
              );
            }
            _setupIntegrations() {
            ...
            _prepareEvent(e, t, n = qe(), r = We()) {
              ...
              return (
                ...
                ln(i, e, t, n, this, r).then((e) => {
                  if (null === e) return e;
                  e.contexts = { trace: ze(n), ...e.contexts };
            ...
            _captureEvent(e, t = {}, n) {
              return this._processEvent(e, t, n).then(
                ...
                (e) => {
                  P &&
                    (e instanceof ur && "log" === e.logLevel
                      ? F.log(e.message)
                      : F.warn(e));
                }
              );
                ...
                .then((n) => {
                  ...
                  return (function (e, t) {
                    ...
                    if (X(e))
                      return e.then(
                        (e) => {
                          if (!K(e) && null !== e) throw new ur(n);
                          return e;
                        },
                        (e) => {
                          throw new ur(`${t} rejected with ${e}`);
                        }
                      );
                    if (!K(e) && null !== e) throw new ur(n);
                    return e;
            ...
            _flushOutcomes() {
              ...
              if (0 === e.length)
                return void (P && F.log("No outcomes to send"));
              if (!this._dsn)
                return void (
                  P && F.log("No dsn provided, will not send outcomes")
                );
              P && F.log("Sending outcomes:", e);
              const t =
                ((n = e),
                er(
                  (r = this._options.tunnel && Xn(this._dsn)) ? { dsn: r } : {},
                  [
                    [
                      { type: "client_report" },
                      { timestamp: Ae(), discarded_events: n },
                    ],
                  ]
                ));
              var n, r;
          ...
          class hr extends dr {
            constructor(e) {
              ...
              !(function (e, t, n = [t], r = "npm") {
                ...
                i.sdk ||
                  ...
                  (e._metadata = i);
              })(t, "browser", ["browser"], mn.SENTRY_SDK_SOURCE || "npm"),
                super(t),
                t.sendClientReports &&
                  mn.document &&
                  mn.document.addEventListener("visibilitychange", () => {
                    "hidden" === mn.document.visibilityState &&
                      this._flushOutcomes();
                  });
            }
            eventFromException(e, t) {
              return (function (e, t, n, r) {
                const i = Vn(e, t, (n && n.syntheticException) || void 0, r);
                return (
                  be(i),
                  (i.level = "error"),
            ...
            captureUserFeedback(e) {
              if (!this._isEnabled())
                return void (
                  Rt &&
                  F.warn("SDK not enabled, will not capture user feedback.")
                );
          ...
          const vr = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__,
            gr = {};
          function mr(e) {
            gr[e] = void 0;
          }
          ...
          function br(
            ...
            t = (function (e) {
              ...
              return n ? (gr[e] = n.bind(ht)) : n;
            })("fetch")
          ) {
            let n = 0,
              r = 0;
            return yr(e, function (i) {
              ...
              if (!t)
                return mr("fetch"), Ut("No fetch implementation available");
              try {
            ...
            Ar = (function (...e) {
              ...
              return (e, n = 0, r = 0) => {
                ...
                for (let e = n; e < o.length; e++) {
                  ...
                  const a = Ze.test(n) ? n.replace(Ze, "$1") : n;
                  if (!a.match(/\S*Error: /)) {
                    for (const e of t) {
                      const t = e(a);
                      if (t) {
                ...
                return (function (e) {
                  ...
                  return (
                    /sentryWrapped/.test(tt(t).function || "") && t.pop(),
                    t.reverse(),
                    et.test(tt(t).function || "") &&
                      (t.pop(), et.test(tt(t).function || "") && t.pop()),
                    t.slice(0, 50).map((e) => ({
                      ...e,
                      filename: e.filename || tt(t).filename,
                      function: e.function || Xe,
                    }))
                  );
                })(i.slice(r));
              };
              ...
              [
                ...
                (e) => {
                  ...
                  if (t) {
                    ...
                    return (
                      ([n, e] = Cr(n, e)),
                      Sr(e, n, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0)
                    );
                  }
                },
              ]
          ...
          var Or = "new",
            ...
            ai = "cam-mic-in-use",
            si = "permissions",
            ci = "undefined-mediadevices",
            ui = "not-found",
            li = "constraints",
            di = "unknown",
            fi = "iframe-ready-for-launch-config",
            pi = "iframe-launch-config",
            hi = "theme-updated",
            vi = "loading",
            gi = "load-attempt-failed",
            mi = "loaded",
            yi = "started-camera",
            _i = "camera-error",
            bi = "joining-meeting",
            Si = "joined-meeting",
            wi = "left-meeting",
            ki = "participant-joined",
            Ei = "participant-updated",
            Ti = "participant-left",
            Mi = "participant-counts-updated",
            Ai = "access-state-updated",
            Ci = "meeting-session-summary-updated",
            Oi = "meeting-session-state-updated",
            Pi = "meeting-session-data-error",
            Ii = "waiting-participant-added",
            Li = "waiting-participant-updated",
            Di = "waiting-participant-removed",
            Ni = "track-started",
            ji = "track-stopped",
            Ri = "transcription-started",
            xi = "transcription-stopped",
            Fi = "transcription-error",
            Vi = "recording-started",
            Ui = "recording-stopped",
            Bi = "recording-stats",
            Ji = "recording-error",
            Yi = "recording-upload-completed",
            $i = "recording-data",
            qi = "app-message",
            Wi = "transcription-message",
            Gi = "remote-media-player-started",
            zi = "remote-media-player-updated",
            Hi = "remote-media-player-stopped",
            Ki = "local-screen-share-started",
            Qi = "local-screen-share-stopped",
            Xi = "local-screen-share-canceled",
            Zi = "active-speaker-change",
            eo = "active-speaker-mode-change",
            to = "network-quality-change",
            no = "network-connection",
            ro = "cpu-load-change",
            io = "face-counts-updated",
            oo = "fullscreen",
            ao = "exited-fullscreen",
            so = "live-streaming-started",
            co = "live-streaming-updated",
            uo = "live-streaming-stopped",
            lo = "live-streaming-error",
            fo = "lang-updated",
            po = "receive-settings-updated",
            ho = "input-settings-updated",
            vo = "nonfatal-error",
            go = "error",
            mo = 4096,
            yo = 102400,
            _o = "iframe-call-message",
            bo = "local-screen-start",
            So = "daily-method-update-live-streaming-endpoints",
            wo = "transmit-log",
            ko = "daily-custom-track",
            Eo = {
              NONE: "none",
            ...
            To = { NONE: "none", NOISE_CANCELLATION: "noise-cancellation" },
            Mo = { PLAY: "play", PAUSE: "pause" },
            Ao = ["jpg", "png", "jpeg"],
            Co = "sip-call-transfer";
          function Oo() {
            return !Po() &&
          ...
          var Do = "none",
            No = (function () {
              try {
                ...
                var r = null != e;
                return t.remove(), r ? (n ? "software" : "hardware") : Do;
              } catch (e) {
                return Do;
              }
            })();
          function jo() {
            ...
            return (
              ...
              !(No === Do) &&
              (e
                ? !Vo() && ["Chrome", "Firefox"].includes(Uo())
                : (function () {
                    if (Vo()) return !1;
                    var e = Uo();
                    if ("Safari" === e) {
                      var t = qo();
                      if (t.major < 15 || (15 === t.major && t.minor < 4))
                        return !1;
                    }
                    return "Chrome" === e
                      ? Jo().major >= 77
          ...
          function xo() {
            return (
              ...
              !(function () {
                ...
                switch (t) {
                  case "Chrome":
                    return (e = Jo()).major && e.major > 0 && e.major < 75;
                  case "Firefox":
                    return (e = Wo()).major < 91;
                  case "Safari":
                    return (
                      (e = qo()).major < 13 || (13 === e.major && e.minor < 1)
                    );
                  default:
                    return !0;
                }
            ...
            var e,
              ...
              n =
                ...
                e.maxTouchPoints
                  ...
                  : 0) >= 5;
            return (
              !!(t.match(/Mobi/) || t.match(/Android/) || n) ||
              !!Oo().match(/DailyAnd\//) ||
              void 0
            );
          }
            ...
            function t() {
              ...
              return (
                ...
                ((e = u(
                  n,
                  Ko()
                    ? Reflect.construct(r, [], l(n).constructor)
                    : r.apply(n, o)
                ))._wrappedListeners = {}),
                (e._messageCallbacks = {}),
                e
              ...
              c(t, [
                    ...
                    var r = this,
                      i = function (i) {
                        if (
                          ...
                          (!i.data.callClientId || i.data.callClientId === t) &&
                          ...
                          if (
                            (delete o.from,
                            o.callbackStamp &&
                              r._messageCallbacks[o.callbackStamp])
                          ) {
                            var a = o.callbackStamp;
                            r._messageCallbacks[a].call(n, o),
                              delete r._messageCallbacks[a];
                          }
                ...
                },
                {
                  ...
                  value: function (e, t, n, r) {
                    ...
                    var a = r ? r.contentWindow : window,
                      s = this._callMachineTargetOrigin(r);
                    s && a.postMessage(i, s);
                  },
                },
                {
                  ...
                  value: function (e, t) {
                    var n = function (n) {
                      if (
                        ...
                        (!n.data.callClientId || n.data.callClientId === t) &&
              ...
              function t() {
                ...
                return (
                  ...
                  (window.callMachineToDailyJsEmitter =
                    window.callMachineToDailyJsEmitter || new y.EventEmitter()),
                  (window.dailyJsToCallMachineEmitter =
                    window.dailyJsToCallMachineEmitter || new y.EventEmitter()),
                  (e._wrappedListeners = {}),
                  (e._messageCallbacks = {}),
                  e
                );
                      ...
                      var o = this,
                        a = function (t) {
                          if (t.callClientId === n) {
                            if (
                              t.callbackStamp &&
                              o._messageCallbacks[t.callbackStamp]
                            ) {
                              var i = t.callbackStamp;
                              o._messageCallbacks[i].call(r, t),
                                delete o._messageCallbacks[i];
                            }
                            e.call(r, t);
                          }
                        };
                      (this._wrappedListeners[e] = a),
                        t.addListener("message", a);
                    },
                  },
                  {
                    key: "_sendMessage",
          ...
          var ia = (function () {
            function e() {
              var t =
                ...
                o = void 0 === r ? ta : r;
              i(this, e),
                e._validateMergeStrategy(o),
                e._validateData(n, o),
                (this.mergeStrategy = o),
                (this.data = n);
            }
            return c(
              e,
              ...
              [
                {
                  key: "isNoOpUpdate",
                  value: function (e, t) {
                    return 0 === Object.keys(e).length && t === na;
                  },
                },
                {
              ...
              return c(
                ...
                [
                  ...
                  },
                  {
                    ...
                    get: function () {
                      return (
                        this._currentAttempt && this._currentAttempt.cancelled
                      );
                    },
                  },
                  {
                    ...
                    get: function () {
                      return (
                        this._currentAttempt && this._currentAttempt.succeeded
                      );
                    },
                  },
                ]
                ...
                function e(t, n, r) {
                  i(this, e),
                    (this._loadAttemptImpl =
                      Po() || !t.avoidEval ? new ha(t, n, r) : new va(t, n, r));
                },
                [
                  {
                    key: "start",
                            ...
                            (!!t &&
                              (t.code
                                ? (Function('"use strict";' + t.code)(),
                                  ...
                                  this._successCallback(),
                                  !0)
                                : ((this._refetchHeaders = t.refetchHeaders),
                                  !1)))
                          );
                        } catch (e) {
                          return !1;
                      ...
                      ((t = v(function* (e) {
                        ...
                        try {
                          ...
                          Function('"use strict";' + i)(),
                            this._iosCache &&
                              this._iosCache.set(e, i, r.headers),
                            (this.succeeded = !0),
                            this._successCallback();
                        } catch (t) {
                          if (
                    ...
                    value:
                      ((e = v(function* (e, t) {
                        ...
                        if (this._iosCache && 304 === t.status)
                          return (yield this._iosCache.renew(e, t.headers))
                            .code;
                        throw new Error(
                          "Received ".concat(t.status, " response")
                        );
                      })),
                      function (t, n) {
                        return e.apply(this, arguments);
              ...
              return c(
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      window._dailyCallMachineLoadWaitlist.delete(
                        this._attemptId
                      );
                    },
                  },
          ...
          function wa(e, t) {
            for (
              var n = t.getState(), r = 0, i = ["cam", "screen"];
              r < i.length;
              r++
            )
              for (
                var o = i[r], a = 0, s = ["video", "audio"];
                a < s.length;
                a++
              ) {
                var c = s[a],
                  u =
                    "cam" === o
                      ? c
                      : "screen".concat(c.charAt(0).toUpperCase() + c.slice(1)),
                  l = e.tracks[u];
                if (l) {
                  var d = e.local ? ma(n, o, c) : ya(n, e.session_id, o, c);
                  "playable" === l.state && (l.track = d),
                    (l.persistentTrack = d);
                }
              }
          }
              ...
              for (var r in e.tracks)
                if (!Ea(r)) {
                  ...
                  if (i) {
                    var o = e.tracks[r];
                    if (o) {
                      var a = e.local ? Sa(n, r) : ya(n, e.session_id, r, i);
                      "playable" === o.state && (e.tracks[r].track = a),
                        (o.persistentTrack = a);
                    }
          ...
          function Ta(e, t, n) {
            ...
            if (e.local) {
              if (e.audio)
                try {
                  (e.audioTrack =
                    r.local.streams.cam.stream.getAudioTracks()[0]),
                    e.audioTrack || (e.audio = !1);
                } catch (e) {}
              if (e.video)
                try {
                  (e.videoTrack =
                    r.local.streams.cam.stream.getVideoTracks()[0]),
              ...
              try {
                ...
                o &&
                  o.public &&
                  o.public.rtcType &&
                  "peer-to-peer" === o.public.rtcType.impl &&
                  o.private &&
                  !["connected", "completed"].includes(
                    o.private.peeringState
                  ) &&
                  (i = !1);
              } catch (e) {
                console.error(e);
              ...
              try {
                if ((r.streams, e.audio && ga(r, e.session_id, "cam-audio"))) {
                  var a = ya(r, e.session_id, "cam", "audio");
                  a &&
                ...
                if (e.video && ga(r, e.session_id, "cam-video")) {
                  var s = ya(r, e.session_id, "cam", "video");
                  s &&
                    (t && t.videoTrack && t.videoTrack.id === s.id
                      ? (e.videoTrack = s)
                      : s.muted || (e.videoTrack = s)),
                    e.videoTrack || (e.video = !1);
                }
                if (e.screen && ga(r, e.session_id, "screen-audio")) {
                  var c = ya(r, e.session_id, "screen", "audio");
                  c &&
                    (t && t.screenAudioTrack && t.screenAudioTrack.id === c.id
                      ? (e.screenAudioTrack = c)
                      : c.muted || (e.screenAudioTrack = c));
                }
                if (e.screen && ga(r, e.session_id, "screen-video")) {
                  var u = ya(r, e.session_id, "screen", "video");
                  u &&
                    (t && t.screenVideoTrack && t.screenVideoTrack.id === u.id
                      ? (e.screenVideoTrack = u)
                      : u.muted || (e.screenVideoTrack = u));
                }
                e.screenVideoTrack || e.screenAudioTrack || (e.screen = !1);
              } catch (e) {
              ...
              ? (function (e) {
                  Aa.has(e) ||
                    ...
                    navigator.mediaDevices
                      ...
                      .then(function (t) {
                        Aa.has(e) &&
                          ((Aa.get(e).lastDevicesString = JSON.stringify(t)),
                          Ca ||
                            ((Ca = (function () {
                              var e = v(function* () {
                                var e,
                                ...
                                try {
                                  for (n.s(); !(e = n.n()).done; ) {
                                    var r = e.value,
                                      i = JSON.stringify(t);
                                    i !== Aa.get(r).lastDevicesString &&
                                      ((Aa.get(r).lastDevicesString = i), r(t));
                                  }
                                } catch (e) {
                                  n.e(e);
                                } finally {
              ...
              : (function (e) {
                  Pa.has(e) ||
                    ...
                    navigator.mediaDevices
                      ...
                      .then(function (t) {
                        Pa.has(e) &&
                          ((Pa.get(e).lastDevicesString = JSON.stringify(t)),
                          Ia ||
                            (Ia = setInterval(
                              v(function* () {
                                var e,
                                ...
                                try {
                                  for (n.s(); !(e = n.n()).done; ) {
                                    var r = e.value,
                                      i = JSON.stringify(t);
                                    i !== Pa.get(r).lastDevicesString &&
                                      ((Pa.get(r).lastDevicesString = i), r(t));
                                  }
                                } catch (e) {
                                  n.e(e);
                                } finally {
          ...
          var xa = Object.freeze({
            ...
            Ba =
              (Object.freeze(
                Va.reduce(function (e, t, n) {
                  return (e[t] = Ua[n]), e;
                }, {})
              ),
              Object.freeze(
                Ua.reduce(function (e, t, n) {
                  return (e[t] = Va[n]), e;
                }, {})
              ),
              [xa.VIDEO, xa.AUDIO, xa.SCREEN_VIDEO, xa.SCREEN_AUDIO]),
            Ja = Object.values(Fa),
            Ya = ["p", "s", "t"],
            $a =
              (Object.freeze(
                Ja.reduce(function (e, t, n) {
                  return (e[t] = Ya[n]), e;
                }, {})
              ),
              Object.freeze(
                Ya.reduce(function (e, t, n) {
                  return (e[t] = Ja[n]), e;
                }, {})
              ),
              (function () {
                  ...
                  [
                    {
                      ...
                      value: function () {
                        var t = new e();
                        if (
                          (this.base instanceof qa
                            ? (t.base = this.base.clone())
                            : (t.base = this.base),
                          void 0 !== this.byUserId)
                        )
                          for (var n in ((t.byUserId = {}), this.byUserId)) {
                            var r = this.byUserId[n];
                            t.byUserId[n] = r instanceof qa ? r.clone() : r;
                          }
                        if (void 0 !== this.byParticipantId)
                          for (var i in ((t.byParticipantId = {}),
                          this.byParticipantId)) {
                            var o = this.byParticipantId[i];
                            t.byParticipantId[i] =
                              o instanceof qa ? o.clone() : o;
                          }
                        return t;
                      },
                    },
                    {
                      ...
                      value: function () {
                        var e = {};
                        if (
                          ("boolean" == typeof this.base
                            ? (e.base = this.base)
                            : this.base instanceof qa &&
                              (e.base = this.base.toJSONObject()),
                          void 0 !== this.byUserId)
                        )
                          for (var t in ((e.byUserId = {}), this.byUserId)) {
                            var n = this.byUserId[t];
                            e.byUserId[t] =
                              n instanceof qa ? n.toJSONObject() : n;
                          }
                        if (void 0 !== this.byParticipantId)
                          for (var r in ((e.byParticipantId = {}),
                          this.byParticipantId)) {
                            var i = this.byParticipantId[r];
                            e.byParticipantId[r] =
                              i instanceof qa ? i.toJSONObject() : i;
                          }
                        return e;
                      },
                    },
                      ...
                      value: function () {
                        ...
                        if (
                          (void 0 !== this.base &&
                            ("boolean" == typeof this.base
                              ? (e.b = this.base)
                              : (e.b = this.base.toMinifiedJSONObject())),
                          void 0 !== this.byUserId)
                        )
                          for (var t in ((e.u = {}), this.byUserId)) {
                            var n = this.byUserId[t];
                            e.u[t] =
                              "boolean" == typeof n
                                ? n
                                : n.toMinifiedJSONObject();
                          }
                        if (void 0 !== this.byParticipantId)
                        ...
                        return (
                          ...
                          this.byUserId &&
                            (this.byUserId = Object.fromEntries(
                              Object.entries(this.byUserId).map(function (e) {
                                var t = m(e, 2),
                                  n = t[0],
                                  r = t[1];
                                return [n, r instanceof qa ? r.normalize() : r];
                              })
                            )),
                          this.byParticipantId &&
                            (this.byParticipantId = Object.fromEntries(
                              Object.entries(this.byParticipantId).map(
                                function (e) {
                                  var t = m(e, 2),
                                    n = t[0],
                                    r = t[1];
                  ...
                  [
                    {
                      ...
                      value: function (t) {
                        ...
                        if (
                          (void 0 !== t.base &&
                            (n =
                              "boolean" == typeof t.base
                                ? t.base
                                : qa.fromJSONObject(t.base)),
                          void 0 !== t.byUserId)
                        )
                          for (var o in ((r = {}), t.byUserId)) {
                            var a = t.byUserId[o];
                            r[o] =
                              "boolean" == typeof a ? a : qa.fromJSONObject(a);
                          }
                        if (void 0 !== t.byParticipantId)
                          for (var s in ((i = {}), t.byParticipantId)) {
                            var c = t.byParticipantId[s];
                            i[s] =
                              "boolean" == typeof c ? c : qa.fromJSONObject(c);
                          }
                        return new e({
                          base: n,
                          byUserId: r,
                    ...
                    },
                    {
                      ...
                      value: function (e) {
                        if ("object" !== o(e))
                          return [!1, "canReceive must be an object"];
                        for (
                          var t = ["base", "byUserId", "byParticipantId"],
                            n = 0,
                            r = Object.keys(e);
                          n < r.length;
                          n++
                          ...
                          if (!t.includes(i))
                            return [
                              !1,
                              "canReceive can only contain keys (".concat(
                                t.join(", "),
                                ")"
                              ),
                            ];
                          if ("base" === i) {
                            var a = m(qa.validateJSONObject(e.base, !0), 2),
                              s = a[0],
                              c = a[1];
                            if (!s) return [!1, c];
                          } else {
                            if ("object" !== o(e[i]))
                              return [
                                !1,
                                "invalid (non-object) value for field '".concat(
                                  i,
                                  "' in canReceive"
                                ),
                              ];
                            for (
                              var u = 0, l = Object.values(e[i]);
                              u < l.length;
                              u++
                            ) {
                              var d = l[u],
                                f = m(qa.validateJSONObject(d), 2),
                                p = f[0],
                                h = f[1];
                              if (!p) return [!1, h];
                            }
                ...
                [
                  {
                    ...
                    value: function () {
                      var t = new e();
                      return (
                        void 0 !== this.video && (t.video = this.video),
                        void 0 !== this.audio && (t.audio = this.audio),
                        void 0 !== this.screenVideo &&
                          (t.screenVideo = this.screenVideo),
                        void 0 !== this.screenAudio &&
                          (t.screenAudio = this.screenAudio),
                        void 0 !== this.customVideo &&
                          (t.customVideo = Ra({}, this.customVideo)),
                        void 0 !== this.customAudio &&
                          (t.customAudio = Ra({}, this.customAudio)),
                        t
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      var e = {};
                      return (
                        void 0 !== this.video && (e.video = this.video),
                        void 0 !== this.audio && (e.audio = this.audio),
                        void 0 !== this.screenVideo &&
                          (e.screenVideo = this.screenVideo),
                        void 0 !== this.screenAudio &&
                          (e.screenAudio = this.screenAudio),
                        void 0 !== this.customVideo &&
                          (e.customVideo = Ra({}, this.customVideo)),
                        void 0 !== this.customAudio &&
                          (e.customAudio = Ra({}, this.customAudio)),
                        e
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      var e = {};
                      return (
                        void 0 !== this.video && (e.v = this.video),
                        void 0 !== this.audio && (e.a = this.audio),
                        void 0 !== this.screenVideo &&
                          (e.sv = this.screenVideo),
                        void 0 !== this.screenAudio &&
                          (e.sa = this.screenAudio),
                        void 0 !== this.customVideo &&
                          (e.cv = Ra({}, this.customVideo)),
                        void 0 !== this.customAudio &&
                          (e.ca = Ra({}, this.customAudio)),
                        e
                      );
                    },
                  },
                    ...
                    value: function () {
                      ...
                      return (
                        !(
                          ...
                          !0 !== this.screenVideo ||
                          !0 !== this.screenAudio ||
                          !e(this.customVideo, !0) ||
                          !e(this.customAudio, !0)
                        ) ||
                        ((!1 !== this.video ||
                          !1 !== this.audio ||
                          !1 !== this.screenVideo ||
                          !1 !== this.screenAudio ||
                          !e(this.customVideo, !1) ||
                          !e(this.customAudio, !1)) &&
                          this)
                      );
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      return new e({
                        ...
                        customVideo:
                          void 0 !== t.customVideo
                            ? Ra({}, t.customVideo)
                            : void 0,
                        customAudio:
                          void 0 !== t.customAudio
                            ? Ra({}, t.customAudio)
                            : void 0,
                      });
                    },
                    ...
                    value: function (e, t) {
                      ...
                      for (
                        ...
                        if (!Va.includes(a))
                          return [
                            !1,
                            "invalid media type '".concat(a, "' in canReceive"),
                          ];
                        if (Ba.includes(a)) {
                          if ("boolean" != typeof e[a])
                            return [
                              !1,
                              "invalid (non-boolean) value for media type '".concat(
                                a,
                                "' in canReceive"
                              ),
                            ];
                          ...
                          if ("object" !== o(e[a]))
                            return [
                              !1,
                              "invalid (non-object) value for media type '".concat(
                                a,
                                "' in canReceive"
                              ),
                            ];
                          for (
                            var s = 0, c = Object.values(e[a]);
                            s < c.length;
                            s++
                          )
                            if ("boolean" != typeof c[s])
                              return [
                                !1,
                                "invalid (non-boolean) value for entry within '".concat(
                                  a,
                                  "' in canReceive"
                                ),
                              ];
                          if (t && void 0 === e[a]["*"])
                            return [
                              !1,
                              'canReceive "base" permission must specify "*" as an entry within \''.concat(
                                a,
                                "'"
                              ),
                            ];
                      ...
                      return t && n.length !== Va.length
                        ? [
                            !1,
                            'canReceive "base" permission must specify all media types: '.concat(
                              Va.join(", "),
          ...
          var Za = {},
            ...
            os = Object.keys(is),
            as = ["state", "volume", "simulcastEncodings"],
            ss = {
            ...
            ls = {
              customIntegrations: { validate: js, help: Ds() },
              customTrayButtons: {
                validate: Ns,
              ...
              videoSource: {
                validate: function (e, t) {
                  if ("boolean" == typeof e)
                    return (t._preloadCache.allowLocalVideo = e), !0;
                  var n;
                  if (e instanceof MediaStreamTrack)
                    (t._sharedTracks.videoTrack = e), (n = { customTrack: ko });
                  else {
                    if (
                      (delete t._sharedTracks.videoTrack, "string" != typeof e)
                    )
                      return (
                        console.error(
              ...
              audioSource: {
                validate: function (e, t) {
                  if ("boolean" == typeof e)
                    return (t._preloadCache.allowLocalAudio = e), !0;
                  var n;
                  if (e instanceof MediaStreamTrack)
                    (t._sharedTracks.audioTrack = e), (n = { customTrack: ko });
                  else {
                    if (
                      (delete t._sharedTracks.audioTrack, "string" != typeof e)
                    )
                      return (
                        console.error(
              ...
              subscribeToTracksAutomatically: {
                validate: function (e, t) {
                  return (
                    (t._preloadCache.subscribeToTracksAutomatically = e), !0
                  );
                },
              },
              theme: {
              ...
              receiveSettings: {
                validate: function (e) {
                  return Ts(e, { allowAllParticipantsKey: !1 });
                },
                help: Ls({ allowAllParticipantsKey: !1 }),
              },
              sendSettings: {
                validate: function (e, t) {
                  return (
              ...
              inputSettings: {
                validate: function (e, t) {
                  ...
                  return (
                    !!Ms(e) &&
                    (t._inputSettings || (t._inputSettings = {}),
                    As(
                      e,
                    ...
                    t._updatePreloadCacheInputSettings(e, !0),
                    !0)
                  );
                },
                help: Is(),
            ...
            ds = {
              styles: {
                validate: function (e) {
                  ...
                  if (e.cam)
                    for (var n in e.cam)
                      if ("div" !== n && "video" !== n) return !1;
                  if (e.screen)
                    for (var r in e.screen)
                      if ("div" !== r && "video" !== r) return !1;
                  return !0;
                },
              ...
              setSubscribedTracks: {
                validate: function (e, t) {
                  ...
                  var n = [!0, !1, "staged"];
                  if (n.includes(e) || (!Po() && "avatar" === e)) return !0;
                  var r = [
                      "audio",
                      "video",
                      "screenAudio",
                  ...
                  for (var t = 0, n = Object.entries(e); t < n.length; t++) {
                    ...
                    switch (i) {
                      ...
                      case "canSend":
                        ...
                        (o instanceof Array || Array.isArray(o)) &&
                          (e.canSend = new Set(o));
                        break;
                      case "canReceive":
                        var l = m($a.validateJSONObject(o), 2),
                          d = l[0],
                          f = l[1];
                      ...
                      case "canAdmin":
                        if (
                          ...
                          var p,
                            h = ["participants", "streaming", "transcription"],
                            v = Qa(o);
                          try {
                            for (v.s(); !(p = v.n()).done; ) {
                              var g = p.value;
                              if (!h.includes(g)) return !1;
                            }
                          } catch (e) {
                            v.e(e);
                          } finally {
          ...
          var fs = (function (e) {
            function t(e) {
              ...
              if (
                ...
                p(
                  (r = u(
                    o,
                    Ka()
                      ? Reflect.construct(a, [], l(o).constructor)
                      : a.apply(o, s)
                  )),
                  "startListeningForDeviceChanges",
                  function () {
                    La(r.handleDeviceChange);
                  }
                ),
                p(r, "stopListeningForDeviceChanges", function () {
                  var e;
                  (e = r.handleDeviceChange),
                    Da()
                      ? (function (e) {
                          Aa.has(e) &&
                            (Aa.delete(e),
                      ...
                      : (function (e) {
                          Pa.has(e) &&
                            ...
                            0 === Pa.size &&
                              Ia &&
                              (clearInterval(Ia), (Ia = null)));
                        })(e);
                }),
                p(r, "handleDeviceChange", function (e) {
                  (e = e.map(function (e) {
                    ...
                    var e = v(function* (e) {
                      if ("destroyed" === e)
                        return (
                          ...
                          void (yield r.destroy())
                        );
                      var t = "active" === e;
                      r.disableReactNativeAutoDeviceManagement("video") ||
                        (t
                          ? r.camUnmutedBeforeLosingNativeActiveState &&
                            r.setLocalVideo(!0)
                          : ((r.camUnmutedBeforeLosingNativeActiveState =
                              r.localVideo()),
                            r.camUnmutedBeforeLosingNativeActiveState &&
                ...
                p(r, "handleNativeAudioFocusChange", function (e) {
                  r.disableReactNativeAutoDeviceManagement("audio") ||
                    ((r._hasNativeAudioFocus = e),
                    r.toggleParticipantAudioBasedOnNativeAudioFocus(),
                    r._hasNativeAudioFocus
                      ? r.micUnmutedBeforeLosingNativeAudioFocus &&
                        r.setLocalAudio(!0)
                      : ((r.micUnmutedBeforeLosingNativeAudioFocus =
                          r.localAudio()),
                        r.setLocalAudio(!1)));
                }),
                p(r, "handleNativeSystemScreenCaptureStop", function () {
                  r.stopScreenShare();
                }),
                !xo() && !Po())
              )
              ...
              if (
                ((r.strictMode = void 0 === d.strictMode || d.strictMode),
                (r.allowMultipleCallInstances =
                  null !== (n = d.allowMultipleCallInstances) &&
                  void 0 !== n &&
                  n),
                Object.keys(Za).length &&
                  (r._logDuplicateInstanceAttempt(),
                  !r.allowMultipleCallInstances))
              ) {
                if (r.strictMode)
                  throw new Error(
                ...
                console.warn(
                  "Using strictMode: false to allow multiple call instances is now deprecated. Set `allowMultipleCallInstances: true`"
                );
              }
              if (
                (window._daily ||
                ...
                (r.callClientId = T()),
                (Za[(c = r).callClientId] = c),
                (window._daily.instances[r.callClientId] = {}),
                (r._sharedTracks = {}),
                (window._daily.instances[r.callClientId].tracks =
                  r._sharedTracks),
                (d.dailyJsVersion = t.version()),
                (r._iframe = e),
                (r._callObjectMode = "none" === d.layout && !r._iframe),
                (r._preloadCache = {
                ...
                void 0 !== d.showLocalVideo
                  ? r._callObjectMode
                    ? console.error(
                        "showLocalVideo is not available in call object mode"
                      )
                    : (r._showLocalVideo = !!d.showLocalVideo)
                  : (r._showLocalVideo = !0),
                void 0 !== d.showParticipantsBar
                  ? r._callObjectMode
                    ? console.error(
                        "showParticipantsBar is not available in call object mode"
                      )
                    : (r._showParticipantsBar = !!d.showParticipantsBar)
                  : (r._showParticipantsBar = !0),
                void 0 !== d.customIntegrations
                  ? r._callObjectMode
                    ? console.error(
                        "customIntegrations is not available in call object mode"
                      )
                    : (r._customIntegrations = d.customIntegrations)
                  : (r._customIntegrations = {}),
                void 0 !== d.customTrayButtons
                  ? r._callObjectMode
                    ? console.error(
                        "customTrayButtons is not available in call object mode"
                      )
                    : (r._customTrayButtons = d.customTrayButtons)
                  : (r._customTrayButtons = {}),
                void 0 !== d.activeSpeakerMode
                  ? r._callObjectMode
                    ? console.error(
                        "activeSpeakerMode is not available in call object mode"
                      )
                    : (r._activeSpeakerMode = !!d.activeSpeakerMode)
                  : (r._activeSpeakerMode = !1),
                d.receiveSettings
                  ? r._callObjectMode
                    ? (r._receiveSettings = d.receiveSettings)
                    : console.error(
                        "receiveSettings is only available in call object mode"
                      )
                  : (r._receiveSettings = {}),
                r.validateProperties(d),
                (r.properties = Ha({}, d)),
                r._inputSettings || (r._inputSettings = {}),
                (r._callObjectLoader = r._callObjectMode
                  ? new ua(r.callClientId)
                  : null),
                (r._callState = Or),
                (r._isPreparingToJoin = !1),
                (r._accessState = { access: Jr }),
                (r._meetingSessionSummary = {}),
                (r._finalSummaryOfPrevSession = {}),
                (r._meetingSessionState = Us(ns, r._callObjectMode)),
                (r._nativeInCallAudioMode = es),
                (r._participants = {}),
                (r._isScreenSharing = !1),
                (r._participantCounts = rs),
                (r._rmpPlayerState = {}),
                (r._waitingParticipants = {}),
                (r._network = {
                  threshold: "good",
                  quality: 100,
                ...
                (r._activeSpeaker = {}),
                (r._localAudioLevel = 0),
                (r._isLocalAudioLevelObserverRunning = !1),
                (r._remoteParticipantsAudioLevel = {}),
                (r._isRemoteParticipantsAudioLevelObserverRunning = !1),
                (r._maxAppMessageSize = mo),
                (r._messageChannel = Po() ? new ea() : new Qo()),
                r._iframe &&
                  (r._iframe.requestFullscreen
                    ? r._iframe.addEventListener(
                        "fullscreenchange",
                        function () {
                          document.fullscreenElement === r._iframe
                            ? (r.emitDailyJSEvent({ action: oo }),
                              r.sendMessageToCallMachine({ action: oo }))
                            : (r.emitDailyJSEvent({ action: ao }),
                              r.sendMessageToCallMachine({ action: ao }));
                        }
                      )
                ...
                var f = r.nativeUtils();
                (f.addAudioFocusChangeListener &&
                  f.removeAudioFocusChangeListener &&
                  f.addAppStateChangeListener &&
                  f.removeAppStateChangeListener &&
                  f.addSystemScreenCaptureStopListener &&
                  f.removeSystemScreenCaptureStopListener) ||
                  console.warn(
                  ...
                  f.addAudioFocusChangeListener(r.handleNativeAudioFocusChange),
                  f.addAppStateChangeListener(r.handleNativeAppStateChange),
                  f.addSystemScreenCaptureStopListener(
                    r.handleNativeSystemScreenCaptureStop
                  );
              }
              return (
                r._callObjectMode && r.startListeningForDeviceChanges(),
                r._messageChannel.addListenerForMessagesFromCallMachine(
                  r.handleMessageFromCallMachine,
                  r.callClientId,
                  r
                ),
                r
              ...
              c(
                ...
                [
                      ...
                      ((te = v(function* () {
                        ...
                        if (
                          ...
                          r.removeAudioFocusChangeListener(
                            ...
                            r.removeAppStateChangeListener(
                        ...
                        this._callObjectMode &&
                          ...
                          this.strictMode && (this.callClientId = void 0);
                      })),
                      function () {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (
                        bs(this._callObjectMode, "accessState()"),
                        this._accessState
                      );
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (
                        bs(this._callObjectMode, "waitingParticipants()"),
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      for (var n in t) {
                        ...
                        if (
                          ds[n].validate &&
                          !ds[n].validate(t[n], this, this._participants[e])
                        )
                          throw new Error(ds[n].help);
                      }
                    },
                  },
                  {
                    ...
                    value:
                      ((ee = v(function* () {
                        ...
                        if (
                          ...
                          vs(this._callState, "updateWaitingParticipant()"),
                          "string" != typeof t || "object" !== o(n))
                        )
                          throw new Error(
                        ...
                        var e = this,
                          t =
                            arguments.length > 0 && void 0 !== arguments[0]
                              ...
                              : {},
                          n = t.access,
                          r = void 0 === n ? { level: Yr } : n,
                          i = t.name,
                          o = void 0 === i ? "" : i;
                        return (
                          bs(this._callObjectMode, "requestAccess()"),
                          vs(this._callState, "requestAccess()"),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      if (
                        ((this._preloadCache.allowLocalAudio = e),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      if (
                        ((this._preloadCache.allowLocalVideo = e),
                        this._callMachineInitialized)
                      )
                        return (
                          this.sendMessageToCallMachine({
                    ...
                    value:
                      ((Q = v(function* (e) {
                        var t = this,
                          ...
                          r = void 0 !== n && n;
                        if (
                          (bs(this._callObjectMode, "getReceiveSettings()"),
                          !this._callMachineInitialized)
                        )
                  ...
                  },
                  {
                    ...
                    value:
                      ((K = v(function* (e) {
                        var t = this;
                        if (
                          (bs(this._callObjectMode, "updateReceiveSettings()"),
                          !Ts(e, { allowAllParticipantsKey: !0 }))
                        )
                          throw new Error(Ls({ allowAllParticipantsKey: !0 }));
                        return (
                          vs(
                            this._callState,
                    ...
                    value: function (e, t) {
                      if (e) {
                        ...
                        if (e.audio) {
                          var r, i, o;
                          e.audio.settings &&
                            ((!Object.keys(e.audio.settings).length && t) ||
                              (n.audio = {
                                settings: Ha({}, e.audio.settings),
                              })),
                            t &&
                              null !== (r = n.audio) &&
                              void 0 !== r &&
                          ...
                          var a =
                            "none" ===
                              (null === (i = e.audio.processor) || void 0 === i
                                ? void 0
                                : i.type) &&
                            (null === (o = e.audio.processor) || void 0 === o
                              ? void 0
                              : o._isDefaultWhenNone);
                          if (e.audio.processor && !a) {
                            var s = Ha({}, e.audio.processor);
                            delete s._isDefaultWhenNone,
                              (n.audio = Ha(
                                Ha({}, n.audio),
                                {},
                                { processor: s }
                        ...
                        if (e.video) {
                          var c, u, l;
                          e.video.settings &&
                            ((!Object.keys(e.video.settings).length && t) ||
                              (n.video = {
                                settings: Ha({}, e.video.settings),
                              })),
                            t &&
                              null !== (c = n.video) &&
                              void 0 !== c &&
                          ...
                          var d =
                            "none" ===
                              (null === (u = e.video.processor) || void 0 === u
                                ? void 0
                                : u.type) &&
                            (null === (l = e.video.processor) || void 0 === l
                              ? void 0
                              : l._isDefaultWhenNone);
                          if (e.video.processor && !d) {
                            var f = Ha({}, e.video.processor);
                            delete f._isDefaultWhenNone,
                              (n.video = Ha(
                                Ha({}, n.video),
                                {},
                                { processor: f }
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e,
                        ...
                        o,
                        a = {
                          processor: { type: "none", _isDefaultWhenNone: !0 },
                        };
                      this._inputSettings
                        ? ((e =
                            (null === (n = this._inputSettings) || void 0 === n
                              ? void 0
                              : n.video) || a),
                          (t =
                            (null === (r = this._inputSettings) || void 0 === r
                              ? void 0
                              : r.audio) || a))
                        : ((e =
                            (null === (i = this._preloadCache) ||
                            void 0 === i ||
                            null === (i = i.inputSettings) ||
                            void 0 === i
                              ? void 0
                              : i.video) || a),
                          (t =
                            (null === (o = this._preloadCache) ||
                            void 0 === o ||
                            null === (o = o.inputSettings) ||
                            void 0 === o
                              ? void 0
                              : o.audio) || a));
                      var s = { audio: t, video: e };
                      return this._prepInputSettingsForSharing(s, !0);
                    },
                  },
                  {
                      ...
                      e.video
                        ? ((u.video = {}),
                          e.video.settings
                            ? ((u.video.settings = {}),
                              t ||
                              e.video.settings.customTrack ||
                              null === (i = c.video) ||
                              void 0 === i ||
                              !i.settings
                                ? (u.video.settings = e.video.settings)
                                : (u.video.settings = Ha(
                                    Ha({}, c.video.settings),
                                    e.video.settings
                                  )),
                              Object.keys(u.video.settings).length ||
                                delete u.video.settings)
                            : null !== (n = c.video) &&
                              void 0 !== n &&
                              n.settings &&
                              (u.video.settings = c.video.settings),
                          e.video.processor
                            ? (u.video.processor = e.video.processor)
                            : null !== (r = c.video) &&
                              void 0 !== r &&
                              r.processor &&
                              (u.video.processor = c.video.processor))
                        : c.video && (u.video = c.video);
                      e.audio
                        ? ((u.audio = {}),
                          e.audio.settings
                            ? ((u.audio.settings = {}),
                              t ||
                              e.audio.settings.customTrack ||
                              null === (s = c.audio) ||
                              void 0 === s ||
                              !s.settings
                                ? (u.audio.settings = e.audio.settings)
                                : (u.audio.settings = Ha(
                                    Ha({}, c.audio.settings),
                                    e.audio.settings
                                  )),
                              Object.keys(u.audio.settings).length ||
                                delete u.audio.settings)
                            : null !== (o = c.audio) &&
                              void 0 !== o &&
                              o.settings &&
                              (u.audio.settings = c.audio.settings),
                          e.audio.processor
                            ? (u.audio.processor = e.audio.processor)
                            : null !== (a = c.audio) &&
                              void 0 !== a &&
                              a.processor &&
                              (u.audio.processor = c.audio.processor))
                        : c.audio && (u.audio = c.audio);
                      this._maybeUpdateInputSettings(u);
                    },
                  },
                  {
                      ...
                      var t,
                        ...
                        i =
                          ...
                          void 0 === n
                            ? void 0
                            : n.deviceId) || null,
                        o = this._preloadCache.outputDeviceId || null;
                      return {
                        camera: r ? { deviceId: r } : {},
                        mic: i ? { deviceId: i } : {},
                        speaker: o ? { deviceId: o } : {},
                      };
                    },
                  },
                  {
                          ...
                          Ms(e)
                            ? e.video || e.audio
                              ? (As(
                                ...
                                this._callObjectMode &&
                                !this._callMachineInitialized
                                  ? (this._updatePreloadCacheInputSettings(
                                      e,
                                      !0
                                    ),
                                      ...
                                      t.sendMessageToCallMachine(
                                        ...
                                        function (i) {
                                          if (i.error) r(i.error);
                                            ...
                                            if (i.returnPreloadCache)
                                              return (
                                                t._updatePreloadCacheInputSettings(
                                                  e,
                                                  !0
                                                ),
                                                void n(t._getInputSettings())
                                              );
                                            t._maybeUpdateInputSettings(
                                              i.inputSettings
                                            ),
                                              n(
                                                t._prepInputSettingsForSharing(
                                                  i.inputSettings,
                                                  !0
                                                )
                                              );
                              ...
                              : this._getInputSettings()
                            : (console.error(Is()), Promise.reject(Is()))
                        );
                      })),
                      function (e) {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if ((ws(), this._callMachineInitialized))
                        return (
                          this.sendMessageToCallMachine({
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [Nr, jr].includes(this._callState)
                    ...
                    value:
                      ((z = v(function* () {
                        ...
                        return (
                          ...
                          vs(this._callState, "getMeetingSession()"),
                          new Promise(function (t) {
                            e.sendMessageToCallMachine(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (
                        vs(this._callState, "meetingSessionState"),
                    ...
                    value: function (e) {
                      var t =
                        arguments.length > 1 && void 0 !== arguments[1]
                          ? arguments[1]
                          : "replace";
                      bs(this._callObjectMode, "setMeetingSessionData()"),
                        vs(this._callState, "setMeetingSessionData");
                      try {
                        !(function (e, t) {
                          new ia({ data: e, mergeStrategy: t });
                        })(e, t);
                      } catch (e) {
                      ...
                      try {
                        ...
                        throw new Error(
                          "Error setting meeting session data: ".concat(e)
                        );
                      }
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value:
                      ((G = v(function* (e) {
                        ...
                        if (
                          ((this.properties.userData = e),
                          this._callMachineInitialized)
                        )
                          return new Promise(function (n) {
                            try {
                              t.sendMessageToCallMachine(
                                { action: "set-user-data", userData: e },
                                function (e) {
                              ...
                              throw new Error(
                                "Error setting user data: ".concat(e)
                              );
                            }
                          });
                      })),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = this;
                      if ("undefined" == typeof AudioWorkletNode && !Po())
                        throw new Error(
                          "startLocalAudioLevelObserver() is not supported on this browser"
                        );
                      if (
                        (this.validateAudioLevelInterval(e),
                        this._callMachineInitialized)
                      )
                        return (
                          (this._isLocalAudioLevelObserverRunning = !0),
                          new Promise(function (n, r) {
                            t.sendMessageToCallMachine(
                              {
                              ...
                              function (e) {
                                (t._isLocalAudioLevelObserverRunning =
                                  !e.error),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      (this._preloadCache.localAudioLevelObserver = null),
                        ...
                        (this._isLocalAudioLevelObserverRunning = !1),
                        this.sendMessageToCallMachine({
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        ...
                        return (
                          (this._isRemoteParticipantsAudioLevelObserverRunning =
                            !0),
                          new Promise(function (n, r) {
                            t.sendMessageToCallMachine(
                              {
                              ...
                              function (e) {
                                (t._isRemoteParticipantsAudioLevelObserverRunning =
                                  !e.error),
                                  e.error ? r({ error: e.error }) : n();
                              }
                            );
                        ...
                        var e = this,
                          t =
                            arguments.length > 0 && void 0 !== arguments[0]
                              ...
                              : {};
                        if (
                          (bs(this._callObjectMode, "startCamera()"),
                          ms(
                            this._callState,
                          ...
                          this.validateProperties(t),
                            (this.properties = Ha(Ha({}, this.properties), t));
                        }
                        return new Promise(function (t) {
                          (e._preloadCache.inputSettings =
                            e._prepInputSettingsForSharing(
                              e._inputSettings,
                              !1
                            )),
                            e.sendMessageToCallMachine(
                              {
                                action: "start-camera",
                                properties: hs(e.properties, e.callClientId),
                                preloadCache: hs(
                                  e._preloadCache,
                                  e.callClientId
                                ),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      return (
                        ws(),
                        vs(this._callState, "stopCustomTrack()"),
                        new Promise(function (n) {
                          t.sendMessageToCallMachine(
                            { action: "stop-custom-track", mediaTag: e },
                            function (e) {
                              n(e.mediaTag);
                            }
                          );
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      return (
                        ks(),
                        ys(this._callMachineInitialized, "setCamera()"),
                        new Promise(function (n) {
                          t.sendMessageToCallMachine(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return new Promise(function (n) {
                        e.sendMessageToCallMachine(
                          { action: "cycle-camera", properties: t },
                          function (e) {
                            n({ device: e.device });
                          }
                        );
                    ...
                    value:
                      (($ = v(function* (e) {
                        ...
                        if (
                          ...
                          void 0 !== o && (r = o),
                          "boolean" == typeof n &&
                            (this._setAllowLocalAudio(n), (n = void 0)),
                          "boolean" == typeof r &&
                            (this._setAllowLocalVideo(r), (r = void 0)),
                          !n && !r)
                        )
                        ...
                        return (
                          n &&
                            (n instanceof MediaStreamTrack
                              ? ((this._sharedTracks.audioTrack = n),
                                (n = ko),
                                (a.audio = { settings: { customTrack: n } }))
                              : (delete this._sharedTracks.audioTrack,
                                (a.audio = { settings: { deviceId: n } }))),
                          r &&
                            (r instanceof MediaStreamTrack
                              ? ((this._sharedTracks.videoTrack = r),
                                (r = ko),
                                (a.video = { settings: { customTrack: r } }))
                              : (delete this._sharedTracks.videoTrack,
                                (a.video = { settings: { deviceId: r } }))),
                          this._callObjectMode && this.needsLoad()
                            ? (this._updatePreloadCacheInputSettings(a, !1),
                              this._devicesFromInputSettings(
                                this._inputSettings
                              ))
                    ...
                    value:
                      ((J = v(function* () {
                        ...
                        return this._callObjectMode && this.needsLoad()
                          ? this._devicesFromInputSettings(this._inputSettings)
                          : new Promise(function (t) {
                              e.sendMessageToCallMachine(
                        ...
                        if (e !== this._nativeInCallAudioMode)
                          return (
                            ...
                            !this.disableReactNativeAutoDeviceManagement(
                              ...
                              gs(this._callState, this._isPreparingToJoin) &&
                        ...
                        var e = this,
                          t =
                            arguments.length > 0 && void 0 !== arguments[0]
                              ...
                              : {};
                        if (
                          (bs(this._callObjectMode, "preAuth()"),
                          ms(
                            this._callState,
                            this._isPreparingToJoin,
                            "preAuth()"
                          ),
                          this.needsLoad() && (yield this.load(t)),
                          !t.url)
                        )
                          throw new Error(
                              ...
                              e.sendMessageToCallMachine(
                                ...
                                function (r) {
                                  return r.error
                                    ...
                                    : n(
                                        new Error("unknown error in preAuth()")
                                      );
                                }
                              );
                          })
                    ...
                    value:
                      ((U = v(function* (e) {
                        ...
                        if (this.needsLoad()) {
                          ...
                          return (
                            this._updateCallState(Pr),
                            this.emitDailyJSEvent({ action: vi }),
                            this._callObjectMode
                                  ...
                                  t._callObjectLoader.load(
                                    ...
                                    function (n) {
                                      (t._bundleLoadTime = n
                                        ? "no-op"
                                        : Date.now() - r),
                                        t._updateCallState(Ir),
                                        n && t.emitDailyJSEvent({ action: mi }),
                                        e();
                                    },
                                    function (e, r) {
                                      if (
                                        (t.emitDailyJSEvent({ action: gi }), !r)
                                      ) {
                                        t._updateCallState(jr),
                                        ...
                                        t._maybeSendToSentry(i),
                                          t.emitDailyJSEvent(i),
                                          n(e.msg);
                                      }
                                    }
                                  );
                    ...
                    value:
                      ((V = v(function* () {
                        ...
                        return (
                          ...
                          this._callState === Dr || this._callState === Lr
                            ? (console.warn(
                                "already joined meeting, call leave() before joining again"
                              ),
                              void this.updateIsPreparingToJoin(!1))
                            : (this._updateCallState(Lr, !1),
                              this.emitDailyJSEvent({ action: bi }),
                              (this._preloadCache.inputSettings =
                                this._prepInputSettingsForSharing(
                                  this._inputSettings || {},
                                  !1
                                )),
                              this.sendMessageToCallMachine({
                              ...
                              new Promise(function (t, r) {
                                e._joinedCallback = function (i, o) {
                                  if (e._callState !== jr) {
                                    if ((e._updateCallState(Dr), i))
                                      for (var a in i) {
                                        if (e._callObjectMode) {
                                          var s = e._callMachine().store;
                                          wa(i[a], s),
                                            ka(i[a], s),
                                            Ta(i[a], e._participants[a], s);
                                        }
                                        (e._participants[a] = Ha({}, i[a])),
                    ...
                    value:
                      ((F = v(function* () {
                        ...
                        return (
                          ...
                          new Promise(function (t) {
                            e._callState === Nr || e._callState === jr
                              ? t()
                              : e._callObjectLoader &&
                                !e._callObjectLoader.loaded
                              ? (e._callObjectLoader.cancel(),
                                e._updateCallState(Nr),
                                e.resetMeetingDependentVars(),
                                e.emitDailyJSEvent({ action: Nr }),
                                t())
                              : ((e._resolveLeave = t),
                                e.sendMessageToCallMachine({
                    ...
                    value:
                      ((x = v(function* () {
                        ...
                        if (
                          ...
                          t.screenVideoSendSettings &&
                            this._validateVideoSendSettings(
                              "screenVideo",
                              t.screenVideoSendSettings
                            ),
                          t.mediaStream &&
                            ((this._sharedTracks.screenMediaStream =
                              t.mediaStream),
                            (t.mediaStream = ko)),
                          ...
                          if (yield n.isScreenBeingCaptured())
                            return void this.emitDailyJSEvent({
                              action: vo,
                          ...
                          n.setSystemScreenCaptureStartCallback(function () {
                            n.setSystemScreenCaptureStartCallback(null),
                              e.sendMessageToCallMachine({
                                action: bo,
                                captureOptions: t,
                              });
                        ...
                        } else this.sendMessageToCallMachine({ action: bo, captureOptions: t });
                      })),
                      function () {
                        return x.apply(this, arguments);
                      }),
                  },
                  {
                    key: "stopScreenShare",
                    value: function () {
                      ys(this._callMachineInitialized, "stopScreenShare()"),
                        this.sendMessageToCallMachine({
                    ...
                    value: function () {
                      ...
                      if (
                        ...
                        throw new Error(
                          "invalid type: ".concat(
                            t,
                            ", allowed values 'cloud', 'raw-tracks', or 'local'"
                          )
                        );
                      this.sendMessageToCallMachine(
                        Ha({ action: "local-recording-start" }, e)
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      var e =
                        arguments.length > 0 && void 0 !== arguments[0]
                          ...
                          : {};
                      this.sendMessageToCallMachine(
                        Ha({ action: "local-recording-stop" }, e)
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      var e =
                        arguments.length > 0 && void 0 !== arguments[0]
                          ...
                          : {};
                      this.sendMessageToCallMachine(
                        Ha({ action: "daily-method-start-live-streaming" }, e)
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      var e =
                        arguments.length > 0 && void 0 !== arguments[0]
                          ...
                          : {};
                      this.sendMessageToCallMachine(
                        Ha({ action: "daily-method-stop-live-streaming" }, e)
                      );
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      var t =
                        ...
                        n =
                          ...
                          arguments[2];
                      if (e) {
                        if (!(e instanceof Array || Array.isArray(e)))
                        ...
                        for (var r = 0; r < e.length; r++) {
                          var i = e[r];
                          for (var o in (this._validateEncodingLayerHasValidProperties(
                            i
                          ),
                          i))
                            if (os.includes(o)) {
                              if ("number" != typeof i[o])
                                throw new Error(
                                  "".concat(o, " must be a number")
                                );
                              if (t) {
                                var a = t[o],
                                  s = a.min,
                              ...
                              !["active", "scalabilityMode"].includes(o)
                            )
                              throw new Error(
                                "Invalid key ".concat(o, ", valid keys are:") +
                                  Object.values(os)
                              );
                          if (n && !i.hasOwnProperty("maxBitrate"))
                    ...
                    value:
                      ((R = v(function* (e) {
                        ...
                        try {
                          ...
                          throw (
                            (console.error(
                              "invalid argument Error: ".concat(e)
                            ),
                            console.error(
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      vs(this._callState, "startTranscription()"),
                        this.sendMessageToCallMachine(
                          Ha({ action: "daily-method-start-transcription" }, e)
                        );
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      if ((vs(this._callState, "updateTranscription()"), !e))
                        throw new Error(
                          "updateTranscription Error: options is mandatory"
                        );
                      if ("object" !== o(e))
                        throw new Error(
                          "updateTranscription Error: options must be object type"
                        );
                      ...
                      this.sendMessageToCallMachine(
                        Ha({ action: "daily-method-update-transcription" }, e)
                      );
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      if (
                        (vs(this._callState, "stopTranscription()"),
                        e && "object" !== o(e))
                      )
                        throw new Error(
                          "stopTranscription Error: options must be object type"
                        );
                      if (e && !e.instanceId)
                        throw new Error('"instanceId" not provided');
                      this.sendMessageToCallMachine(
                        Ha({ action: "daily-method-stop-transcription" }, e)
                      );
                    },
                  },
                  {
                    ...
                    value:
                      ((D = v(function* (e) {
                        ...
                        if (e.displayName) {
                          ...
                          if (e.displayName.length >= 200)
                            throw new Error(
                              "Error starting dial out: displayName length must be less than 200"
                            );
                        }
                        if (e.userId) {
                          if ("string" != typeof e.userId)
                            throw new Error(
                              "Error starting dial out: userId must be a string"
                            );
                          if (e.userId.length > 36)
                            throw new Error(
                              "Error starting dial out: userId length must be less than or equal to 36"
                            );
                        }
                        if (
                          (ps(e), e.permissions && e.permissions.canReceive)
                        ) {
                          var r = m(
                              $a.validateJSONObject(e.permissions.canReceive),
                              2
                            ),
                            i = r[0],
                            o = r[1];
                        ...
                        if (e.provider) {
                          if ("daily" !== e.provider)
                            throw new Error(
                              "Error: provider can be set only to 'daily', got: ".concat(
                                e.provider
                              )
                            );
                          if (e.phoneNumber)
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = this;
                      return (
                        vs(this._callState, "stopDialOut()"),
                        new Promise(function (n, r) {
                          t.sendMessageToCallMachine(
                            Ha({ action: "dialout-stop" }, e),
                            function (e) {
                              e.error ? r(e.error) : n(e);
                            }
                          );
                  ...
                  },
                  {
                    ...
                    value:
                      ((L = v(function* (e) {
                        var t = this;
                        if ((vs(this._callState, "sipCallTransfer()"), !e))
                          throw new Error(
                            "sipCallTransfer() requires a sessionId and toEndPoint"
                          );
                        return (
                          (e.useSipRefer = !1),
                          xs(e, "sipCallTransfer"),
                          ps(e),
                          new Promise(function (n, r) {
                            t.sendMessageToCallMachine(
                              Ha({ action: Co }, e),
                  ...
                  },
                  {
                    ...
                    value:
                      ((I = v(function* (e) {
                        var t = this;
                        if ((vs(this._callState, "sipRefer()"), !e))
                          throw new Error(
                            "sessionId and toEndPoint are mandatory parameter"
                          );
                        return (
                          (e.useSipRefer = !0),
                          xs(e, "sipRefer"),
                      ...
                      ((P = v(function* (e) {
                        ...
                        return (
                          ...
                          (function (e) {
                            ...
                            if (r && r[0])
                              throw new Error(
                                "".concat(r[0], " is not valid DTMF tone")
                              );
                          })(e),
                          new Promise(function (n, r) {
                            t.sendMessageToCallMachine(
                              Ha({ action: "send-dtmf" }, e),
                              function (e) {
                                e.error ? r(e.error) : n(e);
                              }
                            );
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e = this;
                      return this._callState !== Dr
                        ? Promise.resolve(
                            Ha({ stats: { latest: {} } }, this._network)
                          )
                        : new Promise(function (t) {
                            e.sendMessageToCallMachine(
                              ...
                              function (n) {
                                t(
                                  Ha(Ha({}, e._network), {}, { stats: n.stats })
                                );
                              }
                            );
                          });
                  ...
                  },
                  {
                    ...
                    value:
                      ((M = v(function* () {
                        var e = this;
                        ws(),
                          bs(this._callObjectMode, "testCallQuality()"),
                          ys(
                            this._callMachineInitialized,
                            "testCallQuality()",
                            null,
                        ...
                        var t = this._testCallAlreadyInProgress,
                          n = function (n) {
                            t || (e._testCallInProgress = n);
                          };
                        if ((n(!0), this.needsLoad()))
                          try {
                          ...
                          e.sendMessageToCallMachine(
                            ...
                            function (i) {
                              ...
                              if ("failed" === a) {
                                ...
                                void 0 !== c &&
                                c.details
                                  ? ((s.error.details = JSON.parse(
                                      s.error.details
                                    )),
                                    (u.error = Ha(
                                      Ha({}, u.error),
                                      {},
                                      { details: Ha({}, u.error.details) }
                                    )),
                                    (u.error.details.duringTest =
                                      "testCallQuality"))
                                  : ((u.error = u.error ? Ha({}, u.error) : {}),
                                    (u.error.details = {
                                      duringTest: "testCallQuality",
                                    })),
                                  e._maybeSendToSentry(u);
                              }
                              n(!1), t(Ha({ result: a }, s));
                            }
                          );
                      ...
                      ((k = v(function* (e) {
                        ...
                        Po()
                          ? (console.warn(
                            ...
                            (t = yield this.testPeerToPeerCallQuality(e)))
                          : (console.warn(
                              "testConnectionQuality() is deprecated: use testCallQuality() instead"
                            ),
                            (t = yield this.testCallQuality()));
                        var n = {
                          result: t.result,
                  ...
                  },
                  {
                    ...
                    value:
                      ((S = v(function* (e) {
                        ...
                        var n = e.videoTrack,
                          r = e.duration;
                        if (!this._validateVideoTrackForNetworkTests(n))
                          throw new Error("Video track error");
                        return (
                          (this._sharedTracks.videoTrackForConnectionQualityTest =
                            n),
                          new Promise(function (e, n) {
                            t.sendMessageToCallMachine(
                              { action: "test-p2p-call-quality", duration: r },
                              function (t) {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      Po()
                        ? (console.warn(
                            "stopTestConnectionQuality() is deprecated: use testPeerToPeerCallQuality() and stopTestPeerToPeerCallQuality() instead"
                          ),
                          this.stopTestPeerToPeerCallQuality())
                        : (console.warn(
                            "stopTestConnectionQuality() is deprecated: use testCallQuality() and stopTestCallQuality() instead"
                          ),
                          this.stopTestCallQuality());
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value:
                      ((b = v(function* (e) {
                        ...
                        if (!this._validateVideoTrackForNetworkTests(e))
                          throw new Error("Video track error");
                        return (
                          (this._sharedTracks.videoTrackForNetworkConnectivityTest =
                            e),
                          new Promise(function (e, n) {
                            t.sendMessageToCallMachine(
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      if ("string" == typeof t) {
                        ...
                        if ("object" !== o(t)) throw new Error(r);
                        if (
                          !t.maxQuality &&
                          !t.encodings &&
                          void 0 === t.allowAdaptiveLayers
                        )
                          throw new Error(
                        ...
                        if (
                          t.maxQuality &&
                          -1 === ["low", "medium", "high"].indexOf(t.maxQuality)
                        )
                          throw new Error(
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      return (
                        ...
                        this.needsLoad()
                          ? ((this._preloadCache.sendSettings = e),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (
                        this._sendSettings || this._preloadCache.sendSettings
                      );
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      var t =
                        arguments.length > 1 && void 0 !== arguments[1]
                          ...
                          : "*";
                      if (
                        (vs(this._callState, "sendAppMessage()"),
                        JSON.stringify(e).length > this._maxAppMessageSize)
                      )
                        throw new Error(
                          "Message data too large. Max size is " +
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      return (
                        ws(),
                        vs(this._callState, "addFakeParticipant()"),
                        this.sendMessageToCallMachine(
                          Ha({ action: "add-fake-participant" }, e)
                        ),
                        this
                      );
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      return (
                        Ss(this._callObjectMode, "setShowNamesMode()"),
                        ws(),
                        e && "always" !== e && "never" !== e
                          ? (console.error(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e =
                        ...
                        arguments[0];
                      return (
                        Ss(this._callObjectMode, "setShowLocalVideo()"),
                        ws(),
                        vs(this._callState, "setShowLocalVideo()"),
                        "boolean" != typeof e
                          ? (console.error(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (
                        Ss(this._callObjectMode, "showLocalVideo()"),
                        ws(),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e =
                        ...
                        arguments[0];
                      return (
                        Ss(this._callObjectMode, "setShowParticipantsBar()"),
                        ws(),
                        vs(this._callState, "setShowParticipantsBar()"),
                        "boolean" != typeof e
                          ? (console.error(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (
                        Ss(this._callObjectMode, "showParticipantsBar()"),
                        ws(),
                        this._showParticipantsBar
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      return (
                        ws(),
                        Ss(this._callObjectMode, "customIntegrations()"),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      return (
                        ws(),
                        Ss(this._callObjectMode, "setCustomIntegrations()"),
                        vs(this._callState, "setCustomIntegrations()"),
                        js(e)
                          ? (this.sendMessageToCallMachine({
                              action: "set-custom-integrations",
                              integrations: e,
                            }),
                            (this._customIntegrations = e),
                            this)
                          : this
                      );
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        (ws(),
                        Ss(this._callObjectMode, "startCustomIntegrations()"),
                        vs(this._callState, "startCustomIntegrations()"),
                        (Array.isArray(e) &&
                          e.some(function (e) {
                            return "string" != typeof e;
                          })) ||
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        (ws(),
                        Ss(this._callObjectMode, "stopCustomIntegrations()"),
                        vs(this._callState, "stopCustomIntegrations()"),
                        (Array.isArray(e) &&
                          e.some(function (e) {
                            return "string" != typeof e;
                          })) ||
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (
                        Ss(this._callObjectMode, "customTrayButtons()"),
                        ws(),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      return (
                        Ss(this._callObjectMode, "updateCustomTrayButtons()"),
                        ws(),
                        vs(this._callState, "updateCustomTrayButtons()"),
                        Ns(e)
                          ? (this.sendMessageToCallMachine({
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = this;
                      return (
                        Ss(this._callObjectMode, "setTheme()"),
                        new Promise(function (n, r) {
                          try {
                            t.validateProperties({ theme: e }),
                              (t.properties.theme = Ha({}, e)),
                              t.sendMessageToCallMachine({
                                action: "set-theme",
                  ...
                  },
                  {
                    ...
                    value:
                      ((g = v(function* () {
                        if (
                          (ws(),
                          this._iframe && !document.fullscreenElement && Lo())
                        )
                          try {
                    ...
                    value:
                      ((d = v(function* () {
                        var e = this,
                          ...
                          n = void 0 === t || t;
                        return this._accessState.access === Jr ||
                          this.needsLoad()
                          ? this.properties.url
                  ...
                  },
                  {
                    ...
                    value:
                      ((a = v(function* (e) {
                        ...
                        return (
                          ws(),
                          vs(this._callState, "setNetworkTopology()"),
                          new Promise(function (n, r) {
                            t.sendMessageToCallMachine(
                  ...
                  },
                  {
                    key: "on",
                    value: function (e, t) {
                      return _().prototype.on.call(this, e, t);
                    },
                  },
                  {
                    key: "once",
                    value: function (e, t) {
                      return _().prototype.once.call(this, e, t);
                    },
                  },
                  {
                    key: "off",
                    value: function (e, t) {
                      return _().prototype.off.call(this, e, t);
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        null != e &&
                        null !== (t = e.dailyConfig) &&
                        void 0 !== t &&
                        t.userMediaAudioConstraints
                      ) {
                        var r, i;
                        Po() ||
                          console.warn(
                            "userMediaAudioConstraints is deprecated. You can override constraints with inputSettings.audio.settings, found in DailyCallOptions."
                          );
                        var o = e.inputSettings || {};
                        (o.audio =
                          (null === (r = e.inputSettings) || void 0 === r
                            ? void 0
                            : r.audio) || {}),
                          (o.audio.settings =
                            (null === (i = e.inputSettings) ||
                            void 0 === i ||
                            null === (i = i.audio) ||
                            void 0 === i
                              ? void 0
                          ...
                          (o.audio.settings = Ha(
                            Ha({}, o.audio.settings),
                            e.dailyConfig.userMediaAudioConstraints
                          )),
                          (e.inputSettings = o),
                          delete e.dailyConfig.userMediaAudioConstraints;
                      }
                      if (
                        null != e &&
                        null !== (n = e.dailyConfig) &&
                        void 0 !== n &&
                        ...
                        Po() ||
                          console.warn(
                            "userMediaVideoConstraints is deprecated. You can override constraints with inputSettings.video.settings, found in DailyCallOptions."
                          );
                        var c = e.inputSettings || {};
                        (c.video =
                          (null === (a = e.inputSettings) || void 0 === a
                            ? void 0
                            : a.video) || {}),
                          (c.video.settings =
                            (null === (s = e.inputSettings) ||
                            void 0 === s ||
                            null === (s = s.video) ||
                            void 0 === s
                              ? void 0
                          ...
                          (c.video.settings = Ha(
                            Ha({}, c.video.settings),
                            e.dailyConfig.userMediaVideoConstraints
                          )),
                          (e.inputSettings = c),
                          delete e.dailyConfig.userMediaVideoConstraints;
                      }
                      for (var u in e)
                        if (ls[u]) {
                          if (ls[u].validate && !ls[u].validate(e[u], this))
                            throw new Error(
                              "property '".concat(u, "': ").concat(ls[u].help)
                            );
                        } else
                          console.warn(
                            "Ignoring unrecognized property '".concat(u, "'")
                          ),
                            delete e[u];
                    },
                  },
                  {
                    ...
                    value: function () {
                      var e,
                        ...
                        n = Ha(
                          ...
                          {},
                          {
                            ...
                            proxy:
                              null !== (e = this.properties.dailyConfig) &&
                              void 0 !== e &&
                              e.proxyUrl
                                ? encodeURIComponent(
                                    null ===
                                      (t = this.properties.dailyConfig) ||
                                      void 0 === t
                                      ? void 0
                                      : t.proxyUrl
                                  )
                      ...
                      return (
                        ...
                        Object.keys(ls)
                          .filter(function (e) {
                            return ls[e].queryString && void 0 !== n[e];
                          })
                          .map(function (e) {
                            return ""
                              .concat(ls[e].queryString, "=")
                              .concat(n[e]);
                          })
                          .join("&")
                      );
                    ...
                    value: function (e) {
                      switch (e.action) {
                        ...
                        case "call-machine-initialized":
                          ...
                          var t = {
                            ...
                            stats: {
                              event: "bundle load",
                              time:
                                "no-op" === this._bundleLoadTime
                                  ? 0
                                  : this._bundleLoadTime,
                              preLoaded: "no-op" === this._bundleLoadTime,
                              url: C(this.properties.dailyConfig),
                            },
                          };
                        ...
                        case Si:
                          ...
                          delete i.internal,
                            (this._maxAppMessageSize =
                              (null === (n = e.internal) || void 0 === n
                                ? void 0
                                : n._maxAppMessageSize) || mo),
                        ...
                        case Ei:
                          ...
                          if (e.participant && e.participant.session_id) {
                            ...
                            if (this._callObjectMode) {
                              ...
                              wa(e.participant, a),
                                ka(e.participant, a),
                                Ta(e.participant, this._participants[o], a);
                            }
                            try {
                              this.maybeParticipantTracksStopped(
                                this._participants[o],
                                e.participant
                              ),
                            ...
                            this.compareEqualForParticipantUpdateEvent(
                              ...
                              ((this._participants[o] = Ha({}, e.participant)),
                        ...
                        case Ti:
                          if (e.participant && e.participant.session_id) {
                            var s =
                              this._participants[e.participant.session_id];
                            s && this.maybeParticipantTracksStopped(s, null),
                          ...
                          break;
                        case Mi:
                          w(this._participantCounts, e.participantCounts) ||
                            ((this._participantCounts = e.participantCounts),
                            this.emitDailyJSEvent(e));
                          break;
                        case Ai:
                          var c = { access: e.access };
                          e.awaitingAccess &&
                            (c.awaitingAccess = e.awaitingAccess),
                            w(this._accessState, c) ||
                              ((this._accessState = c),
                              this.emitDailyJSEvent(e));
                          break;
                        case Ci:
                        ...
                        case go:
                          ...
                          null != d &&
                            ...
                            void 0 !== l &&
                            l.details &&
                            (d.error.details = JSON.parse(d.error.details)),
                            this._maybeSendToSentry(e),
                            this._joinedCallback &&
                              (this._joinedCallback(null, d),
                              (this._joinedCallback = null)),
                            this.emitDailyJSEvent(d);
                          break;
                        case wi:
                          this._callState !== jr && this._updateCallState(Nr),
                            this.resetMeetingDependentVars(),
                            this._resolveLeave &&
                              (this._resolveLeave(),
                        ...
                        case to:
                          var f = e.state,
                            ...
                            v = f.state,
                            g = f.reasons;
                          (v === this._network.networkState &&
                            w(g, this._network.networkStateReasons) &&
                            p === this._network.threshold &&
                            h === this._network.quality) ||
                            ((this._network.networkState = v),
                            (this._network.networkStateReasons = g),
                            (this._network.quality = h),
                            (this._network.threshold = p),
                            (e.networkState = v),
                            g.length && (e.networkStateReasons = g),
                            delete e.state,
                            this.emitDailyJSEvent(e));
                          break;
                        case ro:
                        ...
                        case Di:
                          ...
                          break;
                        case po:
                          w(this._receiveSettings, e.receiveSettings) ||
                        ...
                        case "send-settings-updated":
                          w(this._sendSettings, e.sendSettings) ||
                            ((this._sendSettings = e.sendSettings),
                        ...
                        case "local-audio-level":
                          (this._localAudioLevel = e.audioLevel),
                            (this._preloadCache.localAudioLevelObserver = null),
                            this.emitDailyJSEvent(e);
                          break;
                        case "remote-participants-audio-level":
                          (this._remoteParticipantsAudioLevel =
                            e.participantsAudioLevel),
                            (this._preloadCache.remoteParticipantsAudioLevelObserver =
                              null),
                            this.emitDailyJSEvent(e);
                          break;
                        case Gi:
                          var b = e.session_id;
                          (this._rmpPlayerState[b] = e.playerState),
                            this.emitDailyJSEvent(e);
                          break;
                        case Hi:
                        ...
                        case Oi:
                          var E =
                            ...
                            (e.meetingSessionState &&
                              e.meetingSessionState.topology);
                          (this._meetingSessionState = Us(
                            e.meetingSessionState,
                            this._callObjectMode
                          )),
                            (this._callObjectMode || E) &&
                              this.emitDailyJSEvent(e);
                          break;
                        case Ki:
                          (this._isScreenSharing = !0),
                            this.emitDailyJSEvent(e);
                          break;
                        case Qi:
                        case Xi:
                    ...
                    value: function (e, t) {
                      ...
                      e &&
                        (t.local ||
                          !1 !== t[n] ||
                          e[n] === t[n] ||
                          this.emitDailyJSEvent({ action: Ui }));
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (e, t, n) {
                      var r,
                        i,
                        o =
                          null !== (r = null == t ? void 0 : t.tracks[e]) &&
                          void 0 !== r
                            ? r
                            : null,
                        a =
                          null !== (i = null == n ? void 0 : n.tracks[e]) &&
                          void 0 !== i
                            ? i
                            : null,
                        s = null == o ? void 0 : o.track;
                      if (s) {
                        var c = this._trackStatePlayable(o),
                          u = this._trackStatePlayable(a),
                          l = this._trackChanged(
                            s,
                            null == a ? void 0 : a.track
                          );
                        c &&
                          ((u && !l) ||
                            this.emitDailyJSEvent({
                    ...
                    value: function (e, t) {
                      if (e)
                        for (var n in e.tracks)
                          this.maybeEventTrackStopped(n, e, t);
                    },
                  },
                  {
                    ...
                    value: function (e, t) {
                      if (t)
                        for (var n in t.tracks)
                          this.maybeEventTrackStarted(n, e, t);
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      try {
                        (e.callClientId = this.callClientId),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        ...
                        var i = this._callState === Dr;
                        this.updateShowAndroidOngoingMeetingNotification(i);
                        var o = gs(n, r),
                          a = gs(this._callState, this._isPreparingToJoin);
                        o !== a &&
                      ...
                      if (Po()) {
                        ...
                        for (var n in null == t ? void 0 : t.streams) {
                          ...
                          r &&
                            ...
                            (r.pendingTrack.enabled =
                              this._hasNativeAudioFocus);
                        }
                      }
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      for (
                        var e = 0, t = Object.values(Za);
                        e < t.length;
                        e++
                      ) {
                        var n = t[e];
                        n._callMachineInitialized
                          ? (n.sendMessageToCallMachine({
                              action: wo,
                              level: "warn",
                              code: this.allowMultipleCallInstances
                                ? 9993
                                : 9992,
                            }),
                            (n._delayDuplicateInstanceLog = !1))
                          : (n._delayDuplicateInstanceLog = !0);
                      }
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      var n, r, i, o;
                      if (null !== (n = e.error) && void 0 !== n && n.type) {
                        if (![ri, ti, Zr].includes(e.error.type)) return;
                        if (
                          e.error.type === Zr &&
                          e.error.msg.includes("deleted")
                        )
                          return;
                      }
                      var a =
                          null !== (r = this.properties) &&
                          void 0 !== r &&
                          r.url
                            ? new URL(this.properties.url)
                            : void 0,
                        s = "production";
                      a && a.host.includes(".staging.daily") && (s = "staging");
                      var c,
                        u,
                        l,
                        d,
                        f,
                        p = Kn({}).filter(function (e) {
                          return ![
                            "BrowserApiErrors",
                            "Breadcrumbs",
                            "GlobalHandlers",
                      ...
                      if (
                        ...
                        h.init(),
                        this.session_id &&
                          v.setExtra("sessionId", this.session_id),
                        this.properties)
                      ) {
                        var g = Ha({}, this.properties);
                        (g.userName = g.userName ? "[Filtered]" : void 0),
                          (g.userData = g.userData ? "[Filtered]" : void 0),
                          (g.token = g.token ? "[Filtered]" : void 0),
                          v.setExtra("properties", g);
                      }
                      if (a) {
                        var m = a.searchParams.get("domain");
                        if (!m) {
                          var y = a.host.match(/(.*?)\./);
                          m = (y && y[1]) || "";
                        }
                      ...
                      e.error &&
                        (v.setTag("fatalErrorType", e.error.type),
                        v.setExtra("errorDetails", e.error.details),
                        (null === (c = e.error.details) || void 0 === c
                          ? void 0
                          : c.uri) &&
                          v.setTag("serverAddress", e.error.details.uri),
                        (null === (u = e.error.details) || void 0 === u
                          ? void 0
                          : u.workerGroup) &&
                          v.setTag("workerGroup", e.error.details.workerGroup),
                        (null === (l = e.error.details) || void 0 === l
                          ? void 0
                          : l.geoGroup) &&
                          v.setTag("geoGroup", e.error.details.geoGroup),
                        (null === (d = e.error.details) || void 0 === d
                          ? void 0
                          : d.on) &&
                          v.setTag("connectionAttempt", e.error.details.on),
                        null !== (f = e.error.details) &&
                          void 0 !== f &&
                          f.bundleUrl &&
                          (v.setTag("bundleUrl", e.error.details.bundleUrl),
                          v.setTag(
                            "bundleError",
                        ...
                        v.setTags({
                          callMode: this._callObjectMode
                            ? Po()
                              ? "reactNative"
                              : null !== (i = this.properties) &&
                                void 0 !== i &&
                                null !== (i = i.dailyConfig) &&
                                void 0 !== i &&
                                null !== (i = i.callMode) &&
                                void 0 !== i &&
                                i.includes("prebuilt")
                      ...
                      var _ =
                        (null === (o = e.error) || void 0 === o
                          ? void 0
                          : o.msg) || e.errorMsg;
                      v.captureException(new Error(_));
                    },
                  },
                  {
                    key: "_callMachine",
                    value: function () {
                      var e;
                      return null === (e = window._daily) ||
                        void 0 === e ||
                        null === (e = e.instances) ||
                        void 0 === e ||
                        null === (e = e[this.callClientId]) ||
                        void 0 === e
                        ? void 0
                        : e.callMachine;
                    },
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        (ws(),
                        !e || !e.contentWindow || "string" != typeof e.src)
                      )
                        throw new Error(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (
                        (n.allow = "microphone; camera; autoplay"),
                        (n.style.cssText =
                          "\n      position: fixed;\n      top: 0;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      border: 0;\n      pointer-events: none;\n    "),
                    ...
                    value: function () {
                      var e =
                        arguments.length > 0 && void 0 !== arguments[0]
                          ? arguments[0]
                          : void 0;
                      return e ? Za[e] : Object.values(Za)[0];
                    },
                  },
                ]
              )
          ...
          function ps(e) {
            if (e.extension) {
              if ("string" != typeof e.extension)
                throw new Error(
                  "Error starting dial out: extension must be a string"
                );
              if (e.extension.length > 20)
                throw new Error(
                  "Error starting dial out: extension length must be less than or equal to 20"
                );
            }
            if (e.waitBeforeExtensionDialSec) {
              if ("number" != typeof e.waitBeforeExtensionDialSec)
                throw new Error(
                  "Error starting dial out: waitBeforeExtensionDialSec must be a number"
                );
              if (e.waitBeforeExtensionDialSec > 60)
                throw new Error(
          ...
          function hs(e, t) {
            var n = {};
            for (var r in e)
              if (e[r] instanceof MediaStreamTrack)
                console.warn("MediaStreamTrack found in props or cache.", r),
                  (n[r] = ko);
              else if ("dailyConfig" === r) {
                if (e[r].modifyLocalSdpHook) {
                  var i = window._daily.instances[t].customCallbacks || {};
                  (i.modifyLocalSdpHook = e[r].modifyLocalSdpHook),
                    (window._daily.instances[t].customCallbacks = i),
                    delete e[r].modifyLocalSdpHook;
                }
                if (e[r].modifyRemoteSdpHook) {
                  var o = window._daily.instances[t].customCallbacks || {};
                  (o.modifyRemoteSdpHook = e[r].modifyRemoteSdpHook),
                    (window._daily.instances[t].customCallbacks = o),
            ...
            if (!e) {
              var n = "".concat(
                ...
                arguments.length > 3 && void 0 !== arguments[3] && arguments[3]
                  ? " requires preAuth() or startCamera() to initialize call state."
          ...
          function _s(e) {
            if (e) {
              var t =
                "A pre-call quality test is in progress. Please try ".concat(
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : "This daily-js method",
          ...
          function Es(e) {
            ...
            if ("string" == typeof e) t = e;
              ...
              try {
                ...
                throw Error(
                  "userData must be serializable to JSON: ".concat(e)
                );
              }
            if (t.length > 4096)
              throw Error(
                "userData is too large ("
                  .concat(t.length, " characters). Maximum size suppported is ")
                  .concat(4096, ".")
              );
            return !0;
          }
          ...
          function Ms(e) {
            ...
            for (var t = 0, n = Object.entries(e); t < n.length; t++) {
              ...
              switch (i) {
                ...
                case "audio":
                  if ("object" !== o(a)) return !1;
                  for (var f = 0, p = Object.entries(a); f < p.length; f++) {
                    var h = m(p[f], 2),
                      v = h[0],
                      g = h[1];
                    switch (v) {
          ...
          function As(e, t, n) {
            ...
            e.video &&
              e.video.processor &&
              (jo(
                null !== (r = null == t ? void 0 : t.useLegacyVideoProcessor) &&
                  void 0 !== r &&
                  r
              ) ||
                (e.video.settings ? delete e.video.processor : delete e.video,
                i.push("video"))),
              e.audio &&
                e.audio.processor &&
                (Ro() ||
                  (e.audio.settings ? delete e.audio.processor : delete e.audio,
                  i.push("audio"))),
              i.length > 0 &&
                console.error(
              ...
              e.audio &&
                e.audio.settings &&
                (e.audio.settings.customTrack
                  ? ((n.audioTrack = e.audio.settings.customTrack),
                    (e.audio.settings = { customTrack: ko }))
                  : delete n.audioTrack),
              e.video &&
                e.video.settings &&
                (e.video.settings.customTrack
                  ? ((n.videoTrack = e.video.settings.customTrack),
                    (e.video.settings = { customTrack: ko }))
                  : delete n.videoTrack);
          }
          function Cs(e) {
            if (Po())
              return (
                console.warn(
                  "Video processing is not yet supported in React Native"
                ),
                !1
              );
            var t,
            ...
            return !(
              ...
              (Object.keys(e)
                ...
                .forEach(function (t) {
                  console.warn(
                    "invalid key inputSettings -> audio -> processor : ".concat(
                      t
                    )
                  ),
                    delete e[t];
          ...
          function Os(e) {
            ...
            if (
              ...
              (!Object.values(Eo).includes(t) &&
                (console.error("inputSettings video processor type invalid"),
                1))
            )
              return !1;
            if (e.config) {
              if ("object" !== o(e.config)) return !1;
              if (
                !(function (e, t) {
                  var n = Object.keys(t);
          ...
          function Ps(e) {
            return (
              "object" === o(e) &&
              (!e.customTrack || e.customTrack instanceof MediaStreamTrack)
            );
          }
          function Is() {
            var e = Object.values(Eo).join(" | "),
              t = Object.values(To).join(" | ");
            return "inputSettings must be of the form: { video?: { processor?: { type: [ "
              .concat(e, " ], config?: {} } }, audio?: { processor: {type: [ ")
              .concat(t, " ] } } }");
          }
          function Ls(e) {
          ...
          function Ns(e) {
            if ((e && "object" !== o(e)) || Array.isArray(e))
              return (
                console.error(
            ...
            if (e)
              for (var t = 0, n = Object.entries(e); t < n.length; t++)
                for (
                  var r = m(n[t], 1)[0], i = 0, a = Object.entries(e[r]);
                  i < a.length;
                  i++
                ) {
                  var s = m(a[i], 2),
                  ...
                  switch (c) {
                    ...
                    case "iconPathDarkMode":
                      ...
                      break;
                    case "visualState":
                      if (!["default", "sidebar-open", "active"].includes(u))
                        return (
                          console.error(
                            "customTrayButton "
                              .concat(c, " should be ")
          ...
          function js(e) {
            if (!e || (e && "object" !== o(e)) || Array.isArray(e))
              return console.error(Ds()), !1;
            for (
              var t = function (e) {
                  return "".concat(e, " should be ").concat(us.id[e]);
                },
                n = function (e, t) {
                  return console.error(
                    "customIntegration ".concat(e, ": ").concat(t)
                  );
                },
                r = 0,
                i = Object.entries(e);
              ...
              if (!("location" in e[a]))
                return n(a, "location is required"), !1;
              if (!("src" in e[a]) && !("srcdoc" in e[a]))
                return n(a, "src or srcdoc is required"), !1;
              for (var s = 0, c = Object.entries(e[a]); s < c.length; s++) {
                ...
                switch (l) {
                  ...
                  case "referrerPolicy":
                  case "sandbox":
                    if ("string" != typeof d) return n(a, t(l)), !1;
                    break;
                  case "iconURL":
                    if (!O(d))
                      return n(a, "".concat(l, " should be a url")), !1;
                    break;
                  case "src":
                    if ("srcdoc" in e[a])
                      return n(a, "cannot have both src and srcdoc"), !1;
                    if (!O(d))
                      return (
                        n(a, 'src "'.concat(d, '" is not a valid URL')), !1
                      );
                    break;
                  case "srcdoc":
                    if ("src" in e[a])
                    ...
                    break;
                  case "location":
                    if (!["main", "sidebar"].includes(d)) return n(a, t(l)), !1;
                    break;
                  case "controlledBy":
                    if (
                      "*" !== d &&
                  ...
                  default:
                    if (!us.id[l])
                      return (
                        console.error(
                          "customIntegration does not support key ".concat(l)
                        ),
                        !1
                      );
                }
          ...
          function Rs(e, t) {
            ...
            switch (o(t)) {
              ...
              case "object":
                if ("object" !== o(e)) return !1;
                for (var n in e) if (!Rs(e[n], t[n])) return !1;
                return !0;
              default:
                return !1;
            }
          ...
          function Fs(e) {
            if ("object" !== o(e))
              throw new Error(
                'RemoteMediaPlayerSettings: must be "object" type'
              );
            if (e.state && !Object.values(Mo).includes(e.state))
              throw new Error(
                "Invalid value for RemoteMediaPlayerSettings.state, valid values are: " +
                  JSON.stringify(Mo)
              );
            if (e.volume) {
              if ("number" != typeof e.volume)
                throw new Error(
